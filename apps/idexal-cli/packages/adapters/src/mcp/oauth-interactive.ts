...
import type { Logger, McpOAuthConfig } from "@idexal/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedIdexalCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `Idexal ${this.serverName}`,
