 ...
 */
const INTERACTIVE_REQUIRED_BRAND = Symbol.for("idexal.mcp.oauth.interactiveAuthorizationRequired");
const TEMPORARY_REFRESH_FAILURE_BRAND = Symbol.for("idexal.mcp.oauth.temporaryRefreshFailure");
