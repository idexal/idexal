...
- IAB tabs persist for the lifetime of the current Idexal process. Turn end, session end, an omitted finalize call,
...
- Idexal does not restore these tabs after the Idexal process exits.
