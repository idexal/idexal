...
import type { BrowserClientTransport } from "@idexal/core/browser-client";
import type { NodeReplRequestMeta, NodeReplSession } from "@idexal/core/repl";
import type { BrowserCommand, BrowserCommandResult } from "@idexal/shared";
...
} from "@idexal/shared/node-repl-browser-broker";
import {
