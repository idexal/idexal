...
export const NODE_REPL_BROWSER_BRIDGE_SYMBOL = Symbol.for("idexal.node-repl.browser-control-bridge");
...
export function readNodeReplBrowserRuntimeBridge(
  ...
  if (!bridge || typeof bridge !== "object") {
    throw new Error(
      "Browser runtime bridge is unavailable. Use Browser from a Idexal desktop or shared-host session.",
    );
  }
