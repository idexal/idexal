...
import type { NodeReplCuaAppIdentity, NodeReplRequestMeta, NodeReplSession } from "@idexal/core";
import { CUA_APP_ASSOCIATIONS_META_KEY } from "@idexal/idexal-cua/host-display-contract";
import type { CallToolResult } from "@modelcontextprotocol/sdk/types.js";

export const NODE_REPL_CUA_BRIDGE_SYMBOL = Symbol.for("idexal.node-repl.computer-use-bridge");
