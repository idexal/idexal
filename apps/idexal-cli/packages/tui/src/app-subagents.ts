...
import { SessionEventType, type SessionEvent } from "@idexal/contracts";
import type {
...
export type SubagentItem = IdexalSessionRunningSubagent | IdexalSessionEndedSubagent;
const EMPTY_DIRECTORY: IdexalSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
