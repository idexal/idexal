import type { ModelUsageSummary, TodoItem, TurnId } from "@idexal/contracts";
import { getIdexalCopy } from "@idexal/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getIdexalCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getIdexalCopy(locale), [locale]);
