import type { PermissionOptionsPolicy, PermissionUpdate } from "@idexal/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type IdexalPermissionOption } from "@idexal/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 idexalPermissionUpdateSchema 是 strict，会话语义由
