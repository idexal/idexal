import {
  idexalProviderUpdateAccountConfigParamsSchema,
  type IdexalProviderUpdateAccountConfigResult,
} from "@idexal/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<IdexalProviderUpdateAccountConfigResult> {
  const envelope = parseParams(idexalProviderUpdateAccountConfigParamsSchema, params);
