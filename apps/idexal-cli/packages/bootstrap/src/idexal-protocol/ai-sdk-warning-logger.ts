import type { LogContext, Logger } from "@idexal/contracts";
...
export function installIdexalProtocolAiSdkWarningLogger(logger: Logger): void {
  // AI SDK 默认 warning logger 第一次会用 console.info 写 stdout；
  // app-server --stdio 的 stdout 是 Idexal Protocol NDJSON 帧通道，任何普通文本都会让宿主解析失败。
