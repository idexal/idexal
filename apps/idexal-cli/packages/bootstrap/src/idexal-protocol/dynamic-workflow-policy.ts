import { idexalWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@idexal/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(idexalWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
