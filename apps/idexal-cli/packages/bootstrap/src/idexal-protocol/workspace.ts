import { parseRemoteWorkspaceIdentity, type IdexalWorkspaceRef } from "@idexal/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): IdexalWorkspaceRef {
