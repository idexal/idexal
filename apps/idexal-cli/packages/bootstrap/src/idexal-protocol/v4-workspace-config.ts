...
import { getIdexalAgentModeSelectOptions, normalizeAvailableIdexalMode } from "@idexal/shared";
import type { IdexalSessionSettingsState, IdexalSlashCommand } from "@idexal/shared";
import type { WorkspaceConfigState } from "@idexal/shared/idexal-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpIdexalAgent 的注释）。
