import { idexalWorkspaceUpdateModelIoPreferencesParamsSchema } from "@idexal/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(idexalWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
