...
import type { IdexalComputerUseOperationEvent } from "@idexal/shared";
 ...
 * 而非文档软要求：Idexal 的 node_repl 每个 cell 都是全新 Worker、SDK 绑定不跨 cell，所以
...
export function mapComputerUseOperationEvent(
  event: SessionEvent,
): IdexalComputerUseOperationEvent | undefined {
