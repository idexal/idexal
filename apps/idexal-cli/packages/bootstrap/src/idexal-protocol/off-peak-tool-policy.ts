import { idexalWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@idexal/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(idexalWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
