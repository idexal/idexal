...
import { SqliteSessionStore } from "@idexal/adapters/storage";
import { resolvePath, type ConfigResult } from "@idexal/adapters/config";
import {
...
import type { ModelSelection } from "@idexal/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("Idexal SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("Idexal SQLite migration completed", {
    context: { dbPath },
