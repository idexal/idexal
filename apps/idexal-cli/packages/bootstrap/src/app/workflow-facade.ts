...
import { createNodeExecutionAdapter } from "@idexal/adapters/exec";
...
import type { PrepareUserExecutionBoundary, IdexalAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "idexal-expert" : "idexal-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "idexal-expert" : "idexal-workflow",
