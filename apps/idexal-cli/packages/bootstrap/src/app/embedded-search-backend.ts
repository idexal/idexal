import type { EmbeddedSearchBackend } from "@idexal/contracts";
import { getRuntimeToolRuntime } from "@idexal/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "IDEXAL_EMBEDDED_SEARCH_COMMAND";
