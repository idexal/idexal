...
// ============================================================
// 把 dynamic-workflow 引擎核心的向下副作用端口 WorkflowDriver 落到真实 Idexal AgentRuntime 上：
...
import type { SessionId, WorkflowEscalatePort } from "@idexal/contracts";
import type { TurnResult } from "@idexal/core";
import {
