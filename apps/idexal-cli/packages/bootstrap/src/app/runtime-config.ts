...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@idexal/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@idexal/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@idexal/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（Idexal Protocol session/create 或 CLI
