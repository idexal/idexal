...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@idexal/contracts";
 ...
 *
 *   IdexalApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
