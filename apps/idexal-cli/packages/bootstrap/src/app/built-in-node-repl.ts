import type { McpServerConfig, PluginLoadOutcome } from "@idexal/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { IDEXAL_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { IDEXAL_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
