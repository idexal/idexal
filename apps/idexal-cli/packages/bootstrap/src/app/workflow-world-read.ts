...
//      归这一侧。
//   2. **上限的执行**。常量在纯包（`@idexal/dynamic-workflow` 的 WORLD_READ_CAPS），执行在这里，
...
import type { ExecutionPort, FileSystemPort } from "@idexal/contracts";
import { WORLD_READ_CAPS, WorkflowError, type WorldReadOp } from "@idexal/dynamic-workflow";
import {
