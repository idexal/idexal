import { createDefaultFileWorkspaceHookTrustStore } from "@idexal/adapters/storage";
import {
...
import { SessionEventType } from "@idexal/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@idexal/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.idexal/security。 */
  homeDir?: string;
