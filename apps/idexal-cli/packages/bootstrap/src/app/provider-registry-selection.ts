import { ModelErrorCode, ModelProtocolError } from "@idexal/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): IdexalModelOption {
