...
import { cloneMessageForFork, clonePartForFork } from "@idexal/core";
import { WorkflowError, type ActorSessionSeed } from "@idexal/dynamic-workflow";

/**
 * driver 侧需要的会话转录存取面：读一个会话的全部消息、写一条消息 / 一个 part。
 *
 * 结构上是 {@link import("@idexal/contracts").SessionStorePort} 的真子集，所以生产直接把
