...
import { createModelExecutionContext } from "../../../idexal-protocol/model-execution.js";
...
async function stop(
  ...
  host.logger?.info?.("v4 stop foreground execution inspected", {
    ...
    expectedForegroundExecutionId: payload.expectedForegroundExecutionId,
    module: "bootstrap.idexal_protocol_v4.commands",
...
import { resolveExecutionState } from "@idexal/shared";
