...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@idexal/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@idexal/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@idexal/contracts").MessageId;
      keptMessageIDs?: import("@idexal/contracts").MessageId[];
      targetMessageID?: import("@idexal/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@idexal/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@idexal/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@idexal/contracts").SessionId;
