import { expandCustomCommandPrompt, type CustomCommandContent } from "@idexal/contracts";
import { BUILTIN_IDEXAL_SLASH_COMMAND_HELP_ENTRIES } from "@idexal/shared";
...
const helpEntry = BUILTIN_IDEXAL_SLASH_COMMAND_HELP_ENTRIES.find(
