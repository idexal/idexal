...
export const enUS: IdexalCopy = {
  ...
  cli: {
    ...
    help: (version) => `idexal ${version}

Usage:
  idexal [command] [options]

With no command, idexal opens the full-screen TUI.

Commands:
  app-server Run the Idexal Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting Idexal... Ctrl+C to exit",
    },
    transcript: {
      compact: {
