...
} from "@idexal/contracts/browser-control";
...
const locatorDetails = Symbol("idexal.playwright.locatorDetails");
const setObjectWrapper = Symbol("idexal.playwright.setObjectWrapper");
