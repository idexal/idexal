...
import type { EnvInfo } from "@idexal/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are Idexal Explore, a file search and codebase research specialist for Idexal CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
