...
import { modelSelectionSchema, type ModelSelection } from "@idexal/shared/model-selection";
import type { ModelPropertiesData, ModelOptionSpecsData } from "@idexal/shared/model-config";

export type { ModelSelection } from "@idexal/shared/model-selection";
...
} from "@idexal/shared/model-config";
