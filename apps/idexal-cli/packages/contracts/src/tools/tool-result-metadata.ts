import { z } from "zod";
import { OFFICIAL_MCP_TOOL_ERROR_CODES } from "@idexal/shared";
...
export const CUA_TARGET_APP_DISPLAY_META_KEY = "idexal.cua/target-app-display-v1" as const;
...
export const mcpToolResultDisplayPayloadSchema = z
  .object({
     ...
     * 与 code 同源：`@idexal/shared` 的 OFFICIAL_MCP_TOOL_ERROR_CODES。
     */
    unavailable: z
