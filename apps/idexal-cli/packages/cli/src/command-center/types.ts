...
import type { SupportedLocale, UiLocale } from "@idexal/i18n";
import type { ModelSelection, IdexalModelOption } from "@idexal/shared";
import type {
...
export type CommandCenterModelOption = IdexalModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@idexal/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@idexal/tui").TuiReadSubagentTranscript;
