...
import type { runTui } from "@idexal/tui";
...
const assetPrefix = "idexal-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@idexal/tui/dist/index.js";
...
export const loadTuiRuntime = async (): Promise<TuiRuntimeModule> => {
  ...
  if (!sea.isSea()) {
    return await import("@idexal/tui");
  }
