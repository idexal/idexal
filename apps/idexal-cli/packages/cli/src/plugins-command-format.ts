import { formatJson } from "@idexal/core";
import type { GlobalOptions, JsonValue, RunContext } from "@idexal/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly IdexalAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly IdexalMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetIdexalPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetIdexalPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: IdexalAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: IdexalInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: IdexalMarketplaceSummaryData) {
  return {
    id: marketplace.id,
