...
const DEFAULT_SETTINGS = {
  activeProvider: 'custom' as AIProviderType,
  openaiApiKey: '',
  openaiModel: 'gpt-4',
  anthropicApiKey: '',
  ...
  customGatewayUrl: 'http://localhost:20128/v1',
  customGatewayKey: '',
  customGatewayModel: 'auto/best-coding',
  fontSize: 14,
...
export const useSettingsStore = create<SettingsState>((set, get) => ({
  ...
  saveSettings: () => {
    ...
    const settings = {
      ...
      customGatewayKey: state.customGatewayKey,
      customGatewayModel: state.customGatewayModel,
