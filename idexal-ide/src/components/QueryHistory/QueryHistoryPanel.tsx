...
import {
  FaClock, FaStar, FaCopy, FaCheck, FaPlay, FaTrash, FaSearch, FaDownload, FaFilter, FaBookmark, FaCode, FaCalendar, FaBolt
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="px-3 py-2 border-b border-ide-border space-y-2">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <FaStar size={10} className={showFavoritesOnly ? 'fill-white' : ''} />
            Favorites
          </button>
          ...
          filtered.map(q => (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                >
                  <FaStar size={10} className={q.isFavorite ? 'fill-amber-400 text-amber-400' : ''} />
                </button>
              </div>
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <div className="flex gap-1">
                    <button onClick={e => { e.stopPropagation(); copyQuery(q.id, q.query) }} className="px-2 py-0.5 bg-ide-bg-secondary rounded text-xs flex items-center gap-0.5">
                      {copiedId === q.id ? <FaCheck size={8} className="text-green-400" /> : <FaCopy size={8} />}
                      Copy
                    </button>
