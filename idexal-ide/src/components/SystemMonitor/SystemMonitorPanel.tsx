...
import {
  FaChartLine, FaCode, FaThermometerHalf, FaPause, FaPlay, FaSync, FaExpand, FaClock, FaBolt
} from '../Icon'
        ...
        {selectedTab === 'overview' && (
          <>
            ...
            <div className="bg-ide-bg-secondary/30 border border-ide-border/50 rounded p-2">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-1">
                  <FaCode size={12} className="text-yellow-400" />
            ...
            <div className="bg-ide-bg-secondary/30 border border-ide-border/50 rounded p-2">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-1">
                  <FaCode size={12} className="text-red-400" />
