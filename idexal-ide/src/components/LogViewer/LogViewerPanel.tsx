...
import {
  FaTerminal, FaSearch, FaFilter, FaPause, FaPlay, FaTrash, FaCopy, FaCheck, FaDownload, FaChevronDown, FaExclamationCircle, FaExclamationTriangle, FaInfoCircle, FaBug, FaArrowDown, FaCog, FaClock
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          <FaTerminal size={16} className="text-emerald-400" />
