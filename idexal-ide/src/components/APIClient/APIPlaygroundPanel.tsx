...
import {
  FaGlobe, FaSearch, FaPlus, FaCopy, FaCheck, FaPaperPlane, FaClock, FaSave, FaChevronDown, FaChevronRight, FaTrash, FaDownload, FaUpload, FaFileAlt, FaCode, FaEye, FaEyeSlash, FaLock, FaUnlock, FaBolt
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          <FaGlobe size={16} className="text-blue-400" />
      ...
      <div className="px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          ...
          >
            {isLoading ? <FaBolt size={10} className="animate-spin" /> : <FaPaperPlane size={10} />}
            Send
          </button>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {response ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-ide-text-secondary">
              <FaPaperPlane size={32} className="mb-2 opacity-20" />
