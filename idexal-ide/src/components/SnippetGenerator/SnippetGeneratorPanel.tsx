...
import {
  FaCode, FaCopy, FaCheck, FaSearch, FaChevronDown, FaChevronRight, FaBolt, FaFileAlt, FaThLarge, FaDatabase, FaServer, FaGlobe, FaShieldAlt
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          <FaCode size={16} className="text-fuchsia-400" />
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              <div className="flex items-center justify-between px-3 py-1 bg-ide-bg-secondary/30 border-b border-ide-border">
                <span className="text-xs text-ide-text-secondary">Generated FaCode</span>
