...
import {
  FaCode, FaPlay, FaSquare, FaPaperPlane, FaTrash, FaClock, FaChevronDown, FaArrowUp, FaArrowDown, FaCircle, FaCopy, FaCheck, FaFilter
} from '../Icon'
        ...
        {filteredMessages.length === 0 ? (
          ...
          filteredMessages.map(msg => (
            ...
            >
              <div className="flex items-center gap-2">
                {msg.direction === 'send' ? (
                  <FaArrowUp size={10} className="text-blue-400 flex-shrink-0" />
                ) : (
                  <FaArrowDown size={10} className="text-green-400 flex-shrink-0" />
                )}
