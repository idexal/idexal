...
import {
  FaSearch, FaTimes, FaChevronDown, FaChevronRight, FaFileAlt, FaCode, FaFolder
} from '../Icon'
      ...
      <div className="p-3 space-y-2 border-b border-ide-border">
        <div className="flex gap-2">
          <div className="flex-1 relative">
            <FaSearch className="absolute left-2 top-1/2 -translate-y-1/2 w-4 h-4 text-ide-text-muted" />
            <input
              type="text"
              value={query}
        ...
        >
          {showFilters ? <FaChevronDown className="w-3 h-3" /> : <FaChevronRight className="w-3 h-3" />}
          Filters
        </button>
            ...
            {results.map((result) => (
              <div key={result.file}>
                ...
                >
                  ...
                  <FaFileAlt className="w-3.5 h-3.5 text-ide-text-muted" />
