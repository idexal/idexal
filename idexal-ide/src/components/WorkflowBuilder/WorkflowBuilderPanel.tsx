...
import {
  FaCodeBranch, FaPlus, FaTrash, FaPlay, FaPause, FaCheckCircle, FaTimesCircle, FaClock, FaBolt, FaCode, FaDatabase, FaGlobe, FaShieldAlt, FaPaperPlane, FaArrowRight, FaChevronDown, FaCopy, FaCheck
} from '../Icon'
...
const NODE_LIBRARY: Omit<WorkflowNode, 'x' | 'y' | 'config'>[] = [
  ...
  { id: 'lint', type: 'action', name: 'Lint FaCode', description: 'Run ESLint', icon: '🔍', color: '#3b82f6' },
...
const MOCK_WORKFLOWS: Workflow[] = [
  MOCK_WORKFLOW,
  { id: 'wf-2', name: 'FaCode Review', description: 'Review and validate PRs', status: 'idle', lastRun: new Date(Date.now() - 7200000), nodes: [
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          <FaCodeBranch size={16} className="text-emerald-400" />
