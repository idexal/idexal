...
import {
  FaChartLine, FaSearch, FaSync, FaTimes, FaChevronDown, FaChevronRight, FaCode, FaClock, FaBolt, FaTerminal, FaExclamationTriangle, FaPlay, FaPause, FaCopy, FaCheck, FaFilter
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          <FaChartLine size={16} className="text-red-400" />
          <span className="text-sm font-semibold">Process Manager</span>
        </div>
        <div className="flex items-center gap-1">
          <button onClick={() => setProcesses(MOCK_PROCESSES)} className="p-1 hover:bg-ide-bg-secondary rounded text-ide-text-secondary"><FaSync size={14} /></button>
            ...
            <div key={proc.pid}>
              ...
              >
                ...
                <div className="w-12 text-right flex items-center justify-end gap-0.5">
                  ...
                  >
                    {copied === proc.pid ? <FaCheck size={10} className="text-green-400" /> : <FaCopy size={10} />}
                  </button>
                  <button
                ...
                <div className="px-6 pb-2 bg-ide-bg-secondary/10 border-b border-ide-border/30">
                  ...
                  <div className="flex gap-1 mt-1">
                    <button className="px-2 py-0.5 bg-ide-bg-secondary rounded text-[10px] flex items-center gap-0.5">
                      <FaTerminal size={8} /> Attach
                    </button>
                    <button className="px-2 py-0.5 bg-ide-bg-secondary rounded text-[10px] flex items-center gap-0.5">
                      <FaPause size={8} /> Suspend
                    </button>
