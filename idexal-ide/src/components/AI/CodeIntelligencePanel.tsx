...
import {
  FaSearch, FaArrowRight, FaArrowLeft, FaArrowUp, FaCode, FaFileAlt, FaChevronDown, FaChevronRight, FaCopy, FaCheck, FaExternalLinkAlt, FaEye, FaCodeBranch, FaHashtag, FaLayerGroup, FaBox
} from '../Icon'
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold">FaCode Intelligence</span>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {selectedSymbol ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-ide-text-secondary">
              <FaCode size={48} className="mb-3 opacity-20" />
