...
import {
  FaTimes, FaCheckCircle, FaExclamationCircle, FaInfoCircle, FaExclamationTriangle, FaBell
} from '../Icon'
...
function NotificationItem({ notification, onRemove }: { notification: Notification; onRemove: (id: string) => void }) {
  ...
  const icons = {
    info: <FaInfoCircle className="w-4 h-4 text-ide-accent" />,
    success: <FaCheckCircle className="w-4 h-4 text-ide-success" />,
    warning: <FaExclamationTriangle className="w-4 h-4 text-ide-warning" />,
    error: <FaExclamationCircle className="w-4 h-4 text-ide-error" />,
  }
...
export function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      >
        <FaBell className="w-4 h-4 text-ide-text-muted" />
