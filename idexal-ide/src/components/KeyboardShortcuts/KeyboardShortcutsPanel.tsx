...
import {
  FaCode, FaSearch, FaTerminal, FaCopy, FaCheck, FaTimes, FaEdit, FaCodeBranch, FaThLarge, FaEye, FaCog, FaBolt, FaFileAlt, FaExpand, FaCompress, FaChevronDown, FaChevronRight, FaKeyboard, FaPen
} from '../Icon'
...
const SHORTCUTS: Shortcut[] = [
  // General
  { keys: ['Ctrl', 'K'], description: 'FaTerminal Palette', category: 'General' },
  ...
  { keys: ['Ctrl', 'Shift', 'I'], description: 'Toggle FaCode Metrics', category: 'Panels' },
  ...
  { keys: ['Ctrl', "'"], description: 'Toggle FaCode Review', category: 'Panels' },
  ...
  { keys: ['Ctrl', 'Shift', 'F'], description: 'AI FaCode Review', category: 'AI' },
]

const CATEGORY_ICONS: Record<string, typeof FaKeyboard> = {
  'General': FaTerminal,
  'Editor': FaPen,
  'Navigation': FaEye,
  'Panels': FaThLarge,
    ...
    <div className="flex flex-col h-full bg-ide-bg">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-ide-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold">FaKeyboard Shortcuts</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {filteredCategories.map(([category, shortcuts]) => {
          const Icon = CATEGORY_ICONS[category] || FaKeyboard
      ...
      <div className="px-3 py-1.5 border-t border-ide-border flex items-center justify-between text-[10px] text-ide-text-secondary">
        <span>Press <kbd className="px-1 py-0.5 bg-ide-bg-secondary border border-ide-border/50 rounded font-mono text-[9px]">Ctrl+K</kbd> to open FaTerminal Palette</span>
