...
import {
  FaCode, FaSearch, FaPlus, FaCopy, FaCheck, FaTrash, FaTag, FaChevronDown, FaChevronRight, FaFolder, FaFileAlt, FaStar, FaDownload, FaUpload, FaTimes
} from '../Icon'
              ...
              >
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <button onClick={e => { e.stopPropagation(); toggleFavorite(snippet.id) }} className="flex-shrink-0">
                    {snippet.isFavorite ? <FaStar size={12} className="text-yellow-400 fill-yellow-400" /> : <FaCode size={12} className="text-ide-text-secondary/30" />}
                  </button>
