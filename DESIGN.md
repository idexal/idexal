...
Idexal is a desktop-first and web-compatible AI workspace. The interface should feel calm, dense, and operational rather than decorative.
...
Idexal should use restrained depth. Layer primarily through background contrast, borders, and radius before relying on heavy shadows.
