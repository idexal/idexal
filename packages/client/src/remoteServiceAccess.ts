import { ProxyChannel, type IChannelClient } from "@idexal/rpc";
import {
  IFileService,
...
export class RemoteServiceAccess implements IServiceAccessor {
  ...
  readonly idexalTaskService: IIdexalTaskService;
  readonly windowControllerService: IWindowControllerService;
  readonly idexalAgentService: IIdexalAgentService;
  readonly idexalSessionService: IIdexalSessionService;
  ...
  constructor(channelClient: IChannelClient) {
    ...
    this.idexalTaskService = ProxyChannel.toService<IIdexalTaskService>(
      channelClient.getChannel(IIdexalTaskService.channelName),
    );
    ...
    this.idexalAgentService = ProxyChannel.toService<IIdexalAgentService>(
      channelClient.getChannel(IIdexalAgentService.channelName),
    );
    this.idexalSessionService = ProxyChannel.toService<IIdexalSessionService>(
      channelClient.getChannel(IIdexalSessionService.channelName),
    );
