declare module "*.css";
declare module "@idexal/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_IDEXAL_BASE_URL?: string;
  readonly VITE_IDEXAL_ENDPOINT_ORIGIN?: string;
  readonly VITE_IDEXAL_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
