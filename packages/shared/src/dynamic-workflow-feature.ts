 ...
 */
export const IDEXAL_DYNAMIC_WORKFLOW_MODE_ENV = "IDEXAL_DYNAMIC_WORKFLOW_MODE";
...
export function resolveDynamicWorkflowClientConfig(input: {
  ...
  const override = normalizeDynamicWorkflowMode(input.env?.[IDEXAL_DYNAMIC_WORKFLOW_MODE_ENV]);
