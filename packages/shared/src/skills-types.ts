...
export interface SkillSummary {
   ...
   * 软链导入的技能里 `path` 是 realpath 后的目标文件，`sourcePath` 才指向 `~/.idexal/skills/<name>` 下的链接本体，
...
/** 与 idexal-cli `SkillDiagnosticCode` 同步。变动时一并改 apps/idexal-cli/packages/contracts/src/skills/index.ts。 */
