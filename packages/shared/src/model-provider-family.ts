...
import { IDEXAL_ENV } from "./env.js";
import { buildBigModelCodingPlanTeamManageUrl } from "./idexalEndpoint.js";
...
export const MODEL_PROVIDER_FAMILY_SPECS = [
  ...
  },
  {
    ...
    teamCodingPlanManageUrl: buildBigModelCodingPlanTeamManageUrl({ IDEXAL_ENV }),
  },
