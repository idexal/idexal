export const IDEXAL_AGENT_PROVIDER_NOT_READY_CODE = "IDEXAL_AGENT_PROVIDER_NOT_READY" as const;
export const IDEXAL_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
