...
export type CommandAgentSource = "idexalAgent";
...
export type IdexalCommand = UserCommand | PluginCommand;

export function isUserCommand(command: IdexalCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: IdexalCommand): command is PluginCommand {
