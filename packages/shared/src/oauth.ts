...
/** 凭据解密失败稳定错误码 */
export const CREDENTIAL_DECRYPT_ERROR_CODE = "IDEXAL_CREDENTIAL_DECRYPT_FAILED" as const;
...
/** Host 在检测到 Idexal JWT 失效后通知 Renderer 展示确认并重启。 */
export const IDEXAL_JWT_INVALID_BROADCAST_CHANNEL = "auth:idexal-jwt-invalid";
