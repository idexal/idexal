 ...
 *
 * 模式与 CLI 的 `apps/idexal-cli/packages/telemetry/src/error-sanitizer.ts` 保持一致；两者位于不同
...
/** 官方 GLM 名单之外的历史内置模型；仍是 Idexal 自己发布的稳定 ID，不是用户命名。 */
...
/**
 * 旧报表身份（`builtin:zai` / `builtin:zai-start-plan` 等）是 Idexal 自己的固定 ID。
 *
