...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "idexal-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "idexal-media";
...
export interface IdexalStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleIdexalStdioTapDevProxy: "toggleIdexalStdioTapDevProxy",
  SetIdexalEndpointProduction: "setIdexalEndpointProduction",
  SetIdexalEndpointTest: "setIdexalEndpointTest",
  SetIdexalEndpointCustom: "setIdexalEndpointCustom",
  ResetIdexalEndpoint: "resetIdexalEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 Idexal Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `idexal://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.idexal/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
