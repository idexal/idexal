export type IdexalAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly IdexalAssistantMessagePart[] | undefined,
  nextPart: IdexalAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly IdexalAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly IdexalAssistantMessagePart[]) {
