import type { IdexalPlanStep } from "./idexal-task-types-core.js";
...
function normalizePlanStatus(value: unknown): IdexalPlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): IdexalPlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): IdexalPlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is IdexalPlanStep => step !== null);
