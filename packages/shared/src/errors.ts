...
export const IDEXAL_FILE_LOCK_TIMEOUT_ERROR_CODE = "IDEXAL_FILE_LOCK_TIMEOUT" as const;
...
export function isIdexalFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === IDEXAL_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
