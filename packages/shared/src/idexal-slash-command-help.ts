export type BuiltinIdexalSlashCommandHelpEntry = {
...
export const BUILTIN_IDEXAL_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinIdexalSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    {
      details: ["Deletes Z.ai OAuth credentials from the shared Idexal credential store."],
      name: "logout",
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.idexal/AGENTS.md.",
      ],
      name: "init",
