...
import { IDEXAL_OFFICIAL_PLUGIN_MARKETPLACE_ID } from "../plugin-marketplaces.js";
...
export async function scanOfficialPluginCacheRoots(
  ...
  const cacheRoot = join(pluginStorageRoot, "cache", IDEXAL_OFFICIAL_PLUGIN_MARKETPLACE_ID);
  let pluginEntries;
  try {
