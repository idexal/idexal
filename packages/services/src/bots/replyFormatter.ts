...
import { getCompactToolCallSummary, getPermissionRequestPreview } from "@idexal/shared";
...
function formatEditPermissionKindLabel(
  ...
  // Bugfix: edit 权限标题直接透传 Idexal Agent 的 "Edit <path>" 时，第三方消息无法像 UI kindLabel 一样区分写入/更新/删除。
...
function formatBotChangeSummary(
  changeSummary?: IdexalTaskChangeSummary | null,
