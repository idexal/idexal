...
const messages = {
  "zh-CN": {
    ...
    userNotBound: "当前 bot 未绑定。请先在 idexal UI 生成绑定码，然后发送 **/bind <code>**。",
    ...
    permissionExpired: "权限请求已过期，请在 idexal UI 中处理。",
    permissionHandled: "权限请求已处理。",
    permissionDenied: "已拒绝权限请求。",
    permissionSubmitted: "已提交权限响应。",
    elicitationExpired: "问答请求已过期，请在 idexal UI 中处理。",
    ...
    remoteReconnectUnavailable:
      "当前远端项目 {workspacePath} 未连接，但机器人无法访问远端重连服务。请先在 Idexal 打开该远端项目后重试。",
  ...
  "en-US": {
    ...
    userNotBound:
      "This bot is not bound. Generate a bind code in the idexal UI, then send **/bind <code>**.",
    ...
    bindCodeInvalid: "The bind code is invalid or expired. Generate a new one in the idexal UI.",
    ...
    permissionExpired: "This permission request has expired. Please handle it in the idexal UI.",
    ...
    elicitationExpired: "This question request has expired. Please handle it in the idexal UI.",
    ...
    remoteReconnectUnavailable:
      "The remote workspace {workspacePath} is not connected, but the bot cannot access the remote reconnect service. Open this remote project in Idexal and try again.",
