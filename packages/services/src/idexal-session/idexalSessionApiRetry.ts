import {
  ...
  resolveWorkspaceKey,
  type IdexalSessionApiRetryStatus,
...
export function createIdexalSessionApiRetryRuntimeTracker(): {
  trackApiRetryFromSessionEvent: (
    params: IdexalTaskTarget,
    event: IdexalSessionServiceEvent,
  ) => IdexalSessionServiceEvent;
  withApiRetryRuntime: (snapshot: IdexalSessionStateSnapshot) => IdexalSessionStateSnapshot;
} {
  const apiRetryBySessionKey = new Map<string, IdexalSessionApiRetryStatus | null>();
  ...
  function trackApiRetryFromSessionEvent(
    ...
    if (
      ...
      if (apiRetry !== undefined) {
        ...
        isIdexalModelRetryRecoveryProgressPayload(asRecord(event.event.payload))
      ) {
  ...
  function withApiRetryRuntime(snapshot: IdexalSessionStateSnapshot): IdexalSessionStateSnapshot {
  ...
  function sessionKey(params: IdexalTaskTarget): string {
...
): IdexalSessionApiRetryStatus | null | undefined {
