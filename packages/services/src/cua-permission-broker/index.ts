...
// @idexal/idexal-cua as part of the single-package merge. This file preserves
...
//
// Why two layers:
//   - `@idexal/idexal-cua/broker/server` (51 server files) — broker server +
...
//   - `@idexal/idexal-cua/broker` (protocol) — brokerProtocol / helperErrors /
...
export * from "@idexal/idexal-cua/broker/server";
