...
import type { IdexalAgentMcpServer } from "@idexal/shared";
...
function isFilesystemServer(
  server: IdexalAgentMcpServer,
): server is Extract<IdexalAgentMcpServer, { command: string }> {
  return (
    "command" in server &&
...
export function appendWorkspaceToFilesystemMcpServers(
  mcpServers: IdexalAgentMcpServer[] | undefined,
  workspacePath: string,
): IdexalAgentMcpServer[] | undefined {
