...
export class IdexalStorageStartupGate {
  private current?: IdexalStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<IdexalStorageStartupState>();
  ...
  get snapshot(): IdexalStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = idexalStorageStartupStateSchema.safeParse(input);
