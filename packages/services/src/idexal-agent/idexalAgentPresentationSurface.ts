import type { ServiceAuthorityMode } from "@idexal/shared";

export type IdexalAgentPresentationSurface = "desktop";

interface IdexalAgentPresentationHostFacts {
...
export function resolveIdexalAgentPresentationSurface(
  facts: IdexalAgentPresentationHostFacts,
): IdexalAgentPresentationSurface | undefined {
