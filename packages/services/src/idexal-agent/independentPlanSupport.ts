import { idexalProtocolMethods, idexalRuntimeCapabilitiesSchema } from "@idexal/shared";
import type { IdexalProtocolClient } from "./idexalProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(idexalProtocolMethods.runtimeCapabilities, {}, idexalRuntimeCapabilitiesSchema)
    .then((result) => {
