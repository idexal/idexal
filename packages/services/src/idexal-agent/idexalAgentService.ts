import { requestPluginReferenceCatalog } from "#src/idexal-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@idexal/shared";
/* oxlint-disable eslint(max-lines) -- Idexal Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
import { randomUUID } from "node:crypto";
import { ensureIndependentPlanSupport } from "./independentPlanSupport.js";
import { mkdirSync } from "node:fs";
import { join } from "node:path";
import { Emitter } from "@idexal/rpc";
...
import { completeNewModelSelection } from "@idexal/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  IDEXAL_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  IDEXAL_AGENT_PROVIDER,
  IDEXAL_AGENT_PROVIDER_NOT_READY_CODE,
  IDEXAL_AGENT_PROVIDER_NOT_READY_REASON,
  IDEXAL_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  IDEXAL_PROTOCOL_NAME,
  IDEXAL_PROTOCOL_VERSION,
  idexalMcpListResultSchema,
  idexalPermissionRequestParamsSchema,
  idexalBrowserListParamsSchema,
  idexalBrowserExecuteParamsSchema,
  idexalPluginsConfigureResultSchema,
  idexalPluginsInstallResultSchema,
  idexalPluginsListResultSchema,
  idexalPluginsMarketplaceMutationResultSchema,
  idexalPluginsOverviewResultSchema,
  idexalProcessChildProcessesResultSchema,
  type IdexalProcessChildProcess,
  idexalSkillsReferenceCatalogResultSchema,
  idexalWorkflowsDeleteResultSchema,
  idexalWorkflowsGetResultSchema,
  idexalWorkflowsListResultSchema,
  idexalWorkflowsMoveResultSchema,
  idexalWorkflowsRunsResultSchema,
  idexalWorkflowsUpdateMetaResultSchema,
  idexalPluginsResolveSuggestedReferenceResultSchema,
  idexalPluginOperationProgressNotificationSchema,
  idexalPluginsRestoreBuiltinResultSchema,
  idexalPluginsSetEnabledResultSchema,
  idexalPluginsCancelOperationResultSchema,
  idexalPluginsUninstallResultSchema,
  idexalPluginsValidateResultSchema,
  idexalPluginsDescribeResultSchema,
  idexalAutomationCheckTaskBindingParamsSchema,
  idexalAutomationCreateParamsSchema,
  idexalAutomationDeleteParamsSchema,
  idexalAutomationListParamsSchema,
  idexalAutomationUpdateParamsSchema,
  idexalOffPeakCreateParamsSchema,
  idexalOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  idexalComputerUseOperationEventSchema,
  idexalProviderRuntimeHeadersCancelledSchema,
  idexalProviderRuntimeHeadersRequestParamsSchema,
  idexalProviderTestModelConnectivityResultSchema,
  idexalOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  idexalProtocolEmptyResultSchema,
  idexalProtocolMethods,
  idexalProtocolNotifications,
  idexalMcpTelemetryEventSchema,
  idexalMcpResourceSamplesSchema,
  idexalToolExecResourceSchema,
  idexalProcessResourceSampleSchema,
  idexalSessionCloseResultSchema,
  idexalSessionCompactResultSchema,
  idexalSessionEventsResultSchema,
  idexalSessionGoalResultSchema,
  idexalSessionListResultSchema,
  idexalSessionSubagentsResultSchema,
  idexalSessionMessagesResultSchema,
  idexalSessionEventSchema,
  idexalSessionSendResultSchema,
  idexalSessionRequestRuntimePreferencesParamsSchema,
  idexalSessionRuntimePreferencesResultSchema,
  idexalSessionStateSnapshotSchema,
  idexalSessionSubscribeResultSchema,
  idexalStateUpdatedNotificationSchema,
  idexalUserInputRequestParamsSchema,
  idexalWorkspacePresentationSchema,
  idexalWorkspaceCancelGenerateTextResultSchema,
  idexalWorkspaceGenerateTextResultSchema,
  idexalWorkspaceHookTrustGrantResultSchema,
  idexalWorkspaceUpdateInteractionPreferencesResultSchema,
  idexalWorkspaceUpdateModelIoPreferencesResultSchema,
  idexalProviderUpdateAccountConfigResultSchema,
  type IdexalSessionStateSnapshot,
  type IdexalAutomation,
  type IdexalAutomationRun,
  idexalWorkspaceUpdateOffPeakToolPolicyResultSchema,
  idexalWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  type DynamicWorkflowClientConfig,
  type AgentLaneResourceSample,
  type ProcessResourceCliLane,
  type IdexalMcpTelemetryEvent,
  type IdexalMcpResourceSample,
  type IdexalToolExecResource,
  type IdexalPluginOperationProgressNotification,
  type IdexalTaskMode,
} from "@idexal/shared";
...
} from "#src/idexal-agent/automationToolPolicy.js";
import { IDEXAL_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./idexalAgent.js";
import type {
  IdexalProtocolRequestId,
  ModelSelection,
  IdexalProviderRuntimeHeadersRequestParams,
  IdexalSessionEvent,
  IdexalSessionRuntimePreferencesScope,
  IdexalSavedWorkflowScope,
...
import type {
  IIdexalAgentService,
  IdexalAgentBackgroundBashOutputParams,
  IdexalAgentAppRuntimePreferences,
  IdexalAgentRuntimeLifecycleEvent,
  IdexalAgentAddPluginMarketplaceParams,
  IdexalAgentAppUsageParams,
  IdexalAgentCancelPluginOperationParams,
  IdexalAgentCompactParams,
  IdexalAgentConfigurePluginParams,
  IdexalAgentResetPluginConfigParams,
  IdexalAgentCreateSessionParams,
  IdexalAgentInstallPluginParams,
  IdexalAgentGenerateWorkspaceTextParams,
  IdexalAgentTestModelConnectivityParams,
  IdexalAgentGoalParams,
  IdexalAgentGrantWorkspaceHookTrustParams,
  IdexalAgentInitializeResult,
  IdexalAgentListSessionsParams,
  IdexalAgentListSessionSubagentsParams,
  IdexalAgentReadWorkspacePresentationParams,
  IdexalAgentReadSessionEventsParams,
  IdexalAgentReadSessionMessagesParams,
  IdexalAgentReadSessionParams,
  IdexalAgentRemovePluginMarketplaceParams,
  IdexalAgentRespondSessionRuntimePreferencesParams,
  IdexalAgentResumeSessionParams,
  IdexalAgentSendPromptParams,
  IdexalAgentServiceEvent,
  IdexalAgentSessionSubscribeParams,
  IdexalAgentSessionTarget,
  IdexalAgentSessionRuntimePreferencesRequest,
  IdexalAgentTaskTokenUsageParams,
  IdexalAgentSetModeParams,
  IdexalAgentSetModelParams,
  IdexalAgentSetPluginEnabledParams,
  IdexalAgentSetThoughtLevelParams,
  ...
  IdexalAgentSavedWorkflowTarget,
  ...
  IdexalAgentCuaPermissionObservation,
  ...
  IdexalAgentAttachmentBeginParams,
  IdexalAgentAttachmentChunkParams,
  IdexalAgentAttachmentReadParams,
  IdexalAgentConversationAttachmentReadParams,
  IdexalAgentConversationAttachmentStatParams,
  IdexalAgentAttachmentPreviewSourceParams,
  IdexalAgentAttachmentTerminalParams,
  IdexalAgentConversationCommandParams,
  IdexalAgentCommandsQueryParams,
  IdexalAgentConversationFileChangesParams,
  IdexalAgentConversationFileRewindPreviewParams,
  IdexalAgentConversationRowsRangeParams,
  IdexalAgentConversationPlansParams,
  IdexalAgentConversationWorkflowRunEventsParams,
  IdexalAgentConversationWorkflowRunArtifactDataParams,
  IdexalAgentConversationWorkflowRunArtifactReadParams,
  IdexalAgentConversationWorkflowRunArtifactsParams,
  IdexalAgentConversationWorkflowRunNodeResultParams,
  IdexalAgentConversationWorkflowRunWorkspaceParams,
  IdexalAgentConversationWorkflowRunsParams,
  IdexalAgentConversationResyncParams,
  IdexalAgentConversationSubscribeParams,
  IdexalAgentConversationUnsubscribeParams,
  IdexalAgentConnectionFlowParams,
  IdexalAgentSessionsIndexSubscribeParams,
  IdexalAgentWorkspaceConfigSubscribeParams,
} from "./idexalAgent.js";
import {
  ...
  utf8JsonByteLength,
  IDEXAL_ATTACHMENT_FAULT_CODES,
  IdexalAttachmentFaultError,
  type CommandAck,
...
import {
  readTrustedIdexalAgentV4Connection,
  readTrustedIdexalAgentV4UnsubscribeRoute,
  type IdexalAgentV4ConnectionContext,
} from "./idexalAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/idexal-agent/idexalSessionEventCoalescer.js";
...
import { IdexalAgentMcpStatusModeUnsupportedError } from "#src/idexal-agent/idexalAgentErrors.js";
import { IdexalAgentProcessManager } from "./idexalAgentProcessManager.js";
import type { IdexalAgentProcessManagerOptions } from "./idexalAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  IdexalProtocolRequestTimeoutError,
  type IdexalProtocolClient,
} from "./idexalProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./idexalAgentBrowserAmbientContext.js";
import {
...
import type { PipSessionEvent } from "@idexal/idexal-cua/pip-session";
import { registerMemoryDiagnosticsProvider } from "#src/memoryDiagnostics.js";

const logger = createServiceLogger("idexal-agent-service");
...
interface PendingPermissionRequest {
  client: IdexalProtocolClient;
  protocolRequestId: IdexalProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: IdexalProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: IdexalAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "Idexal agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: IdexalAgentWorkspaceTarget): IdexalWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: IdexalAgentSavedWorkflowTarget,
): params is IdexalAgentWorkspaceTarget & { scope?: IdexalSavedWorkflowScope } {
  return typeof (params as Partial<IdexalAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: IdexalAgentSavedWorkflowTarget): {
  scope?: IdexalSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".idexal", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the Idexal Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.idexal/cli/config.json (mcp.servers), which the agent
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof IdexalProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `Idexal Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: IdexalAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: IdexalAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: IdexalAgentSendPromptParams,
...
function buildSessionCompactParams(params: IdexalAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${IDEXAL_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: IdexalAgentSessionTarget): string {
...
function permissionRequestKey(params: IdexalAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: IdexalAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: IdexalAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface IdexalAgentProviderReadinessSnapshot {
...
): IdexalAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: IdexalAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: IdexalAgentWorkspaceTarget): Error & {
  code: typeof IDEXAL_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("Idexal Agent runtime is not running.") as Error & {
    code: typeof IDEXAL_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = IDEXAL_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateIdexalAgentServiceOptions extends Omit<
  IdexalAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: IdexalSessionRuntimePreferencesScope,
  ) => Promise<IdexalSessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: IdexalAutomation;
    run: IdexalAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: IdexalAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<IdexalProtocolClient, "respondError">,
  request: { id: IdexalProtocolRequestId; method: string },
  workspace: IdexalAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createIdexalAgentService(
  options?: CreateIdexalAgentServiceOptions,
): IIdexalAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new IdexalAgentProcessManager(options);
  ...
  const pluginProcessManager = new IdexalAgentProcessManager({
  ...
  const mcpStatusProcessManager = new IdexalAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<IdexalAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<IdexalAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<IdexalToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<IdexalMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<IdexalMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<IdexalPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<IdexalAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<IdexalProtocolClient>();
  const clientDisposables = new WeakMap<IdexalProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: IdexalAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<IdexalProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<IdexalProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: IdexalProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "Idexal provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "Idexal provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "idexal_agent.runtime_preferences.host_response_timeout",
      module: "services.idexal_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: IDEXAL_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          idexalProtocolMethods.providerUpdateAccountConfig,
          {
            revision: snapshot.revision,
            basedOnIdexalBuiltinRevision: snapshot.basedOnIdexalBuiltinRevision,
        ...
        logger.info(undefined, "account provider config 已交付到 Idexal agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: IdexalProtocolClient;
    preferences: IdexalAgentAppRuntimePreferences;
    workspace: IdexalAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          idexalProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            idexalProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: IdexalAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 Idexal agent", {
  ...
  function getSessionEmitter(params: IdexalAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<IdexalAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<IdexalPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: IdexalAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: IdexalAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: IdexalAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: IdexalAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  ): IdexalAgentV4ConnectionContext {
    return (
      readTrustedIdexalAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: IdexalAgentConversationUnsubscribeParams | IdexalAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedIdexalAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: IdexalAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: IdexalAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: IdexalAgentWorkspaceTarget,
    notification: IdexalStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === idexalProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = idexalProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === idexalProtocolNotifications.processResourceSample) {
          const parsed = idexalProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 Idexal CLI 资源样本", {
        ...
        if (message.method === idexalProtocolNotifications.toolExecResource) {
          const parsed = idexalToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === idexalProtocolNotifications.mcpResourceSamples) {
          const parsed = idexalMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === idexalProtocolNotifications.mcpTelemetry) {
          const parsed = idexalMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 Idexal CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === idexalProtocolNotifications.pluginOperationProgress) {
          const parsed = idexalPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 Idexal Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === idexalProtocolMethods.computerUseOperationEvent) {
          const parsed = idexalComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 Idexal Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = idexalSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 Idexal Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = idexalStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === idexalProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = idexalSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: IdexalSessionRuntimePreferencesResult;
              try {
                preferences = idexalSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: IdexalAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "idexal_agent.runtime_preferences.host_request_dispatched",
            module: "services.idexal_agent",
            requestId,
        ...
        if (request.method === idexalProtocolMethods.interactionRequestPermission) {
          const parsed = idexalPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === idexalProtocolMethods.interactionRequestUserInput) {
          const parsed = idexalUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = idexalProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 Idexal provider runtime headers 请求", {
        ...
        if (request.method === idexalProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = idexalOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.interactionBrowserList) {
          const parsed = idexalBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.interactionBrowserExecute) {
          const parsed = idexalBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.automationCreate) {
          const parsed = idexalAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.offPeakCreate) {
          const parsed = idexalOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.offPeakList) {
          const parsed = idexalOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.automationList) {
          const parsed = idexalAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.automationCheckTaskBinding) {
          const parsed = idexalAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.automationUpdate) {
          const parsed = idexalAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === idexalProtocolMethods.automationDelete) {
          const parsed = idexalAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported Idexal Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: IdexalAgentSessionTarget,
  ...
  function getSessionTraceId(target: IdexalAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof IDEXAL_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof IDEXAL_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = IDEXAL_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: IDEXAL_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof IDEXAL_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === IDEXAL_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    IdexalAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 Idexal Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: IdexalAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          idexalProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          idexalProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          idexalWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 Idexal agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: IdexalAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，Idexal agent 保持只读"
            : "provider/model 尚未就绪，Idexal agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 Idexal agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<IdexalProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.idexal/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: IdexalAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: IdexalAgentSavedWorkflowTarget,
  ): Promise<{ client: IdexalProtocolClient; workspace: IdexalWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<IdexalProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: IdexalAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: IdexalAgentWorkspaceTarget): Promise<IdexalAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 Idexal agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "Idexal agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: IDEXAL_PROTOCOL_NAME,
          protocolVersion: IDEXAL_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "Idexal agent 等待 provider/model 就绪" : "Idexal agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: IDEXAL_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: IdexalAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: IdexalAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: IdexalAgentWorkspaceTarget) {
    ...
    async createSession(params: IdexalAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 Idexal Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          idexalProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "Idexal Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "Idexal Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "Idexal Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "Idexal Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          idexalProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "Idexal Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: IdexalAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 Idexal Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          idexalProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "Idexal Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "Idexal Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "Idexal Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "Idexal Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: IdexalAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        idexalProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: IdexalAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        idexalProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: IdexalAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: IdexalAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: IdexalAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        idexalProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: IdexalAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        idexalProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        idexalProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: IdexalAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        idexalProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: IdexalAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 Idexal Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: IdexalWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              idexalProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              idexalWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("Idexal Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "Idexal Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "Idexal Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: IdexalAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: IdexalAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new IdexalAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, idexalProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: IdexalAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          idexalProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, idexalProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: IdexalAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: IdexalAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        idexalProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: IdexalAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        idexalProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        idexalWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: IdexalAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        idexalProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        idexalWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: IdexalAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        idexalProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        idexalWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: IdexalAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        idexalProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        idexalWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: IdexalAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        idexalProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: IdexalAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        idexalProtocolMethods.workflowsMove,
    ...
    async resolveSuggestedPluginReference(
      ...
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: IdexalProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              idexalProtocolMethods.processChildProcesses,
              {},
              idexalProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: IdexalAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: IdexalAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: IdexalAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: IdexalAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: IdexalAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: IdexalAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        idexalPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: IdexalAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: IdexalAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: IdexalAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: IdexalAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: IdexalAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: IdexalAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: IdexalAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: IdexalAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        idexalProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: IdexalAgentWorkspaceTarget) {
    ...
    async createAutomation(params: IdexalAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as IdexalTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: IdexalAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as IdexalTaskMode | undefined),
    ...
    async deleteAutomation(params: IdexalAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: IdexalAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: IdexalAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: IdexalAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: IdexalAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: IdexalAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: IdexalAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 Idexal Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            idexalProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            idexalWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          idexalProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: IdexalAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        idexalProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: IdexalAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: IdexalAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "Idexal Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          idexalProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          idexalSessionSendResultSchema,
        );
        logger.info(logTraceId, "Idexal Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "Idexal Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "Idexal Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: IdexalAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "Idexal Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          idexalProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "Idexal Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "Idexal Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: IdexalAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 Idexal Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          idexalProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "Idexal Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "Idexal Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: IdexalAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        idexalProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: IdexalAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 Idexal Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          idexalProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "Idexal Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "Idexal Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: IdexalAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        idexalProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: IdexalAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        idexalProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "idexal_agent.runtime_preferences.response_without_pending",
          module: "services.idexal_agent",
          requestId: params.requestId,
        });
        throw new Error(
          `Idexal session runtime preferences request not found: ${params.requestId}`,
        );
      }
      const responseContext = {
        event: "idexal_agent.runtime_preferences.host_response_received",
        module: "services.idexal_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: IdexalAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: IdexalAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: IdexalAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              idexalProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("idexal-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: IdexalAgentConnectionFlowParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: IdexalAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。Idexal Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: IdexalAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: IdexalAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: IdexalAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedIdexalAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // Idexal Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: IdexalAgentCommandsQueryParams) {
      if (!readTrustedIdexalAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: IdexalAgentAttachmentBeginParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: IdexalAgentAttachmentChunkParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: IdexalAgentAttachmentTerminalParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: IdexalAgentAttachmentTerminalParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: IdexalAgentAttachmentReadParams) {
      if (!readTrustedIdexalAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: IdexalAgentConversationAttachmentReadParams) {
      if (!readTrustedIdexalAgentV4Connection(params)) {
        throw new IdexalAttachmentFaultError(
          IDEXAL_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: IdexalAgentConversationAttachmentStatParams) {
      if (!readTrustedIdexalAgentV4Connection(params)) {
        throw new IdexalAttachmentFaultError(
          IDEXAL_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: IdexalAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: IdexalAgentConversationRowsRangeParams) {
      const trusted = readTrustedIdexalAgentV4Connection(params);
    ...
    async conversationPlansV4(params: IdexalAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: IdexalAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: IdexalAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: IdexalAgentBackgroundBashOutputParams) {
      if (!readTrustedIdexalAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: IdexalAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: IdexalAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: IdexalAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: IdexalAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: IdexalAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: IdexalAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: IdexalAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: IdexalAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: IdexalAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: IdexalAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: IdexalAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: IdexalAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: IdexalAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: IdexalAgentRuntimeLifecycleEvent) => void) {
