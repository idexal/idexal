import { resolveWorkspaceKey, type IdexalComputerUseOperationEvent } from "@idexal/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: IdexalComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: IdexalComputerUseOperationEvent,
  ): void {
