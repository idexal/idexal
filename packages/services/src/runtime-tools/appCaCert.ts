...
const APP_CA_CERT_FILE = "idexal-network-ca.pem";
const APP_CA_KEY_FILE = "idexal-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "Idexal Network CA" },
    { name: "organizationName", value: "Idexal" },
  ];
