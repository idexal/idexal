import type { Hook, IdexalWorkspaceHookTrustGrantResult } from "@idexal/shared";
import type { WorkspaceHookBundleSnapshotData } from "@idexal/shared/workspace-hook-discovery";
