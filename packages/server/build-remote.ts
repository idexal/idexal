...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/idexal-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
...
const remoteBundleSource = readFileSync("dist/remote/idexal-server.cjs", "utf-8");
...
console.log("Built dist/remote/idexal-server.cjs");
