...
import type { ISkillsService } from "@idexal/services";
...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: IdexalProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: IdexalProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToIdexalAgent(
      hasProvider ? providerOrSkillsService : IDEXAL_AGENT_PROVIDER,
    );
