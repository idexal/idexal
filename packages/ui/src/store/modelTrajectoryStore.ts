...
declare global {
  interface Window {
    __idexalModelTrajectoryStoreE2E?: typeof useModelTrajectoryStore;
  }
}
...
// 与 __idexalSessionStoreE2E 保持同一模式，暴露 store 本身而不是另造测试专用业务实现。
if (typeof window !== "undefined") {
  window.__idexalModelTrajectoryStoreE2E = useModelTrajectoryStore;
}
