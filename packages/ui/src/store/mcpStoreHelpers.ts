...
const MCP_CONFIG_KEY = "idexal-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "idexal-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  idexalagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "idexalagentmcp" && directorySource && directorySource !== "idexal"
...
export function buildServerList(
  ...
  existingServers: IdexalMcpServer[],
): IdexalMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: IdexalMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: IdexalMcpServer["file"],
    location?: IdexalMcpServer["location"],
  ): IdexalMcpServer {
...
export function getServerPriority(server: IdexalMcpServer): number {
