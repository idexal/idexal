...
import type { IdexalElicitationQuestion, IdexalElicitationRequest } from "@idexal/shared";
import type { InteractionAutoResolution } from "@idexal/shared/idexal-protocol-v4";
...
interface ElicitationDialogProps {
  request: IdexalElicitationRequest;
...
interface NormalizedElicitationQuestion extends IdexalElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: IdexalElicitationRequest): boolean {
