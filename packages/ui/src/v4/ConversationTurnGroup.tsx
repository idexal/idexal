...
function toRetryStatus(apiRetry: ApiRetryState): IdexalApiRetryStatus {
...
function TurnChatLoadingSlot({
  ...
  return (
    <div data-idexal-chat-loading-slot="true" className="min-h-5">
      {visibleRetryStatus ? (
...
function ConversationTurnGroupImpl({
  ...
  const assistantCodeCommentCards = useMemo(
    () =>
      ...
      // 卡片与 idexal-file-citation 的预览卡片保持一致：流式期间只投影正文，
