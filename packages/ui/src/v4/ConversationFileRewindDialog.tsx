...
import type { V4ConversationFileRewindPreviewResult } from "@idexal/shared/idexal-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useIdexalIntl>["intl"]) {
