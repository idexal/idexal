...
import { isIdexalAgentProvider, IDEXAL_AGENT_PROVIDER, type IdexalProvider } from "@idexal/shared";
import type { IModelSelectionService, ModelSelectionView } from "@idexal/services";
import {
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isIdexalAgentProvider(displayProvider);
