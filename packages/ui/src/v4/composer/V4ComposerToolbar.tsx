...
import { useToolbarConfigOptions } from "@/hooks/useIdexalConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<IdexalConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@idexal/provider";
