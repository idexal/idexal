...
import type { ShortcutCommandId, IdexalConfigOption } from "@idexal/shared";
import {
...
function getChatToolbarShortcutKey(
  category: IdexalConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: IdexalConfigOption;
  modeOption?: IdexalConfigOption;
  thoughtOption?: IdexalConfigOption;
}
