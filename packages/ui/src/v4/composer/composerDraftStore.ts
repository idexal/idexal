...
//
// 旧草稿面（idexalSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { submissionModeSchema, type SubmissionMode } from "@idexal/shared/idexal-protocol-v4";
...
const STORAGE_KEY_PREFIX = "idexal-v4-composer-drafts:v1:";
