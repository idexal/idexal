...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__idexalSessionActivity" as const;
...
export type TaskListMetaWithActivity = IdexalTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends IdexalTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: IdexalTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: IdexalTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: IdexalTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: IdexalTaskMeta,
  membershipTask: IdexalTaskMeta,
): IdexalTaskMeta {
