...
const FIND_HIGHLIGHT_NAME = "idexal-v4-conversation-find";
const ACTIVE_FIND_HIGHLIGHT_NAME = "idexal-v4-conversation-find-active";
const SEARCH_RESULT_HIGHLIGHT_NAME = "idexal-v4-conversation-search-result";

const FIND_STYLE_ID = "idexal-v4-conversation-find-highlight-style";
