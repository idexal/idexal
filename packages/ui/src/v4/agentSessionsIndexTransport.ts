// sessions-index 传输面（desktop/host 实现）：桥到 IIdexalAgentService 的 v4 sessions-index 转发面
...
import { sessionsIndexTopic } from "@idexal/shared/idexal-protocol-v4";
...
export function createAgentSessionsIndexTransport(
  ...
  const ensureHandshake = () => {
    ...
    return ensureAgentV4ConnectionHandshake(
      agentService as Pick<IIdexalAgentService, "helloConversationV4" | "initializeConversationV4">,
    );
  };
