import type { CommandAck } from "@idexal/shared/idexal-protocol-v4";
...
export async function sendWithConversationDelayE2E(
  ...
  const host =
    typeof window === "undefined"
      ? undefined
      : (window as Window & { __idexalTransportDelayE2E?: DelayPlan });
  const plan = shouldExposeE2EStoreBridge() ? host?.__idexalTransportDelayE2E : undefined;
