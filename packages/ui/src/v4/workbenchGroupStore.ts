...
import type { IdexalTaskClientMode } from "@idexal/shared";
import {
  INITIAL_PANE_LAYOUT,
  MAX_WORKBENCH_PANES,
  V4_PRIMARY_PANE_ID,
...
const WORKBENCH_GROUP_STORAGE_KEY = "idexal-v4-session-workbench-groups:v1";
...
interface WorkbenchGroupStore extends WorkbenchGroupSnapshot {
  configureClientMode: (clientMode: IdexalTaskClientMode) => void;
...
let workbenchGroupClientMode: IdexalTaskClientMode = "desktop-continuous";
