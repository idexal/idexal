...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Idexal to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let Idexal remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Idexal",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Idexal.",
  ...
  "startup.global.starting_services": "Starting Idexal",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Idexal will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Idexal or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Idexal. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Idexal to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Idexal.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Idexal restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Idexal",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Idexal and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to Idexal bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "Idexal saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "Idexal uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to Idexal.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to Idexal's `/api/bots/webhook` endpoint.",
  ...
  "bots.setup.guide.webhook.bind.3":
    "If the bot uses a secret, also send `x-idexal-bot-secret`; then return here after the bind succeeds.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another Idexal window.",
  ...
  "logout.confirm.title": "Disconnect and restart Idexal?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Idexal Agent writes model-io)",
  ...
  "forceUpdate.title": "Update Idexal to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Idexal to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Idexal CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control Idexal workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Idexal checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Idexal terminal font.",
  ...
  "settings.idexalInteractionBehavior": "Interaction behavior",
  "settings.idexalInteractionBehaviorDescription":
    "While Idexal is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.idexalInteractionBehavior.option.queue": "Queue",
  "settings.idexalInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .idexal/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Idexal installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Idexal task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Idexal",
  ...
  "resourceManager.storage.diskUsage": "Idexal uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Idexal desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Idexal could not verify its Windows secure import component. Reinstall or update Idexal before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Idexal will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Idexal Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Idexal provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Idexal Agent cannot refresh OAuth status. Upgrade or restart Idexal, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Idexal to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Idexal",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Idexal 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Idexal automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Idexal.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Idexal uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Idexal after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Idexal MCP",
  ...
  "sidebar.usage.plan.idexalMcpDescription":
    "Daily aggregate quota for Idexal built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Idexal. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Idexal follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Idexal",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Idexal Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Idexal with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Idexal and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Idexal follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Idexal",
  ...
  "settings.commands.description":
    "Manage Idexal Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.idexalAgent": "Idexal Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Idexal. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Idexal follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Idexal",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .idexalignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".idexalignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint":
    "Save first; .idexalignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using Idexal",
  "settingsSync.agent.idexal": "Idexal Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Idexal settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Idexal",
  ...
  "onboarding.welcome.title": "Welcome to Idexal",
  "onboarding.welcome.start": "Start Idexal",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Idexal imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Idexal will copy {source} to {target}.\nIf the target file already exists, the Idexal default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Idexal anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Idexal anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Idexal will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Idexal to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Idexal app and retry, or ask Idexal to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Idexal in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Idexal: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Idexal in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Idexal Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Idexal MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Idexal MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // Idexal Agent
  "idexal.unavailable": "AI agent not available",
  "idexal.initFailed": "Failed to start AI agent",
  "idexal.error.TASK_OWNED_BY_OTHER_HOST":
    "This task is already running in another connected view.",
  "idexal.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "idexal.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "idexal.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "idexal.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "idexal.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "idexal.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "idexal.error.IDEXAL_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "idexal.error.IDEXAL_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "idexal.error.providerBusiness.1006": "Your login session has expired. Please sign in again.",
  "idexal.error.providerBusiness.1005":
    "Today's free plan quota has been used up. Upgrade to continue now, or wait for the quota to reset.",
  "idexal.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "idexal.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "idexal.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "idexal.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "idexal.error.providerBusiness.3008":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "idexal.error.providerBusiness.3009":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "idexal.error.providerBusiness.3010":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "idexal.error.providerBusiness.3102":
  ...
  "resourceManager.appUsage": "Idexal",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Idexal Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Idexal is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Idexal can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Idexal Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Idexal Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Idexal",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Idexal to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Idexal plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Idexal will verify the Computer Use tools against the exact session when your first session starts.",
