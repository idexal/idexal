...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Idexal 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Idexal 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Idexal 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Idexal",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Idexal。",
  ...
  "startup.global.starting_services": "正在启动 Idexal",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Idexal。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Idexal 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Idexal",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Idexal 后重试",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 Idexal 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "Idexal 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "Idexal 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 Idexal 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 Idexal 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.setup.guide.webhook.bind.3":
    "如果配置了 secret，请同时在请求头里带上 `x-idexal-bot-secret`；绑定成功后再回到这里完成设置。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 Idexal 窗口处理。",
  ...
  "login.title": "欢迎来到 Idexal",
  "login.description": "连接账号，开始使用 Idexal",
  "login.oauth.activeProviderHint": "当前已登录提供方：{provider}。新登录会替换当前登录身份。",
  "login.subscription.comingSoon": "订阅功能即将上线",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Idexal？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Idexal Agent 会落盘 model-io）",
  ...
  "forceUpdate.title": "需要升级 Idexal 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Idexal 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Idexal CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "webRemoteControl.description": "通过聊天机器人控制 Idexal 工作区。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Idexal 终端的字体覆盖。",
  ...
  "settings.idexalInteractionBehavior": "交互行为",
  "settings.idexalInteractionBehaviorDescription":
    "在 Idexal 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.idexalInteractionBehavior.option.queue": "队列",
  "settings.idexalInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .idexal/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Idexal 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Idexal 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Idexal 总占用",
  ...
  "resourceManager.storage.diskUsage": "Idexal 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Idexal 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Idexal 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Idexal。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Idexal 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 Idexal Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Idexal 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Idexal Agent 不支持 OAuth 状态刷新。请升级或重启 Idexal，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Idexal。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Idexal",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Idexal 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Idexal 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Idexal 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Idexal 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Idexal 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Idexal 即可继续编码。",
  ...
  "sidebar.usage.plan.idexalMcpDescription": "Idexal 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Idexal。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Idexal 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Idexal",
  ...
  "settings.subagents.description": "管理 Idexal Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Idexal 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Idexal，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Idexal 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Idexal",
  ...
  "settings.commands.description":
    "管理 Idexal Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Idexal。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Idexal 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Idexal",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .idexalignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".idexalignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .idexalignore",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Idexal 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Idexal",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Idexal",
  "onboarding.welcome.start": "开始使用 Idexal",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Idexal 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Idexal 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Idexal 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Idexal 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Idexal 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Idexal 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Idexal 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "Idexal MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Idexal MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  // Idexal Agent
  "idexal.unavailable": "AI 代理不可用",
  "idexal.initFailed": "启动 AI 代理失败",
  "idexal.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "idexal.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "idexal.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "idexal.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "idexal.error.providerBusiness.1006": "登录状态已失效，请重新登录后再试。",
  "idexal.error.providerBusiness.1005":
    "今日免费计划额度已用完。请升级账户、切换模型，或等待额度恢复。",
  "idexal.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "idexal.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "idexal.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "idexal.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "idexal.error.providerBusiness.3008": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "idexal.error.providerBusiness.3009": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "idexal.error.providerBusiness.3010": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "idexal.error.providerBusiness.3102": "已超过单次最长运行时间，请创建新的闲时任务继续。",
  "idexal.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "idexal.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "idexal.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Idexal 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Idexal 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Idexal 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Idexal 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Idexal 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Idexal",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Idexal 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Idexal 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Idexal 会针对该会话精确验证电脑控制工具。",
