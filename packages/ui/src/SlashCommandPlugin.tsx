 ...
 * 1. `/` 直接展示 Idexal Agent 广播的真实 slash commands，并补充可用 subagents
...
export function SlashCommandPlugin({
  ...
  appCommands,
}: SlashCommandPluginProps & { provider: IdexalProvider }) {
  ...
  // 这里只按 workspacePath 读取会落到 path 桶，表现为 Idexal Agent 已收到 available_commands_update 但 / 面板为空。
