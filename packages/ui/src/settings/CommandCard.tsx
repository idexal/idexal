...
import type { UserCommand, IdexalCommand } from "@idexal/shared";
import { isPluginCommand, isUserCommand } from "@idexal/shared";
...
export function isEditableUserCommand(command: IdexalCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "idexal";
}

interface CommandCardProps {
  command: IdexalCommand;
  onEdit?: (command: IdexalCommand) => void;
  onToggle?: (command: IdexalCommand, enabled: boolean) => void;
  isOperating?: boolean;
