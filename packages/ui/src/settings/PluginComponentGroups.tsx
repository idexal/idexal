import type { IdexalPluginComponentKind } from "@idexal/shared";
...
export interface PluginComponentDisplayGroup {
  kind: IdexalPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<IdexalPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<IdexalPluginComponentKind, string> = {
