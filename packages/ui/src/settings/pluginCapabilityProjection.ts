...
import { compareDocumentPluginPriority, isPluginCommand, isUserCommand } from "@idexal/shared";
...
export function selectBuiltInPlugins(
  ...
  installedPlugins: readonly IdexalInstalledPluginSummary[],
): IdexalPluginInfo[] {
...
interface PluginSettingsGroups {
  installed: IdexalPluginInfo[];
  builtIn: IdexalPluginInfo[];
}
...
export function selectPluginsForScope(
  plugins: readonly IdexalPluginInfo[],
  _installedPlugins: readonly IdexalInstalledPluginSummary[],
  _scope: IdexalPluginScope,
): IdexalPluginInfo[] {
...
export function selectSkillsForScope(
  ...
  scopedPlugins: readonly Pick<IdexalPluginInfo, "id" | "name" | "enabled">[],
...
export function selectCommandsForScope(
  commands: readonly IdexalCommand[],
  scopedPlugins: readonly Pick<IdexalPluginInfo, "id" | "name" | "enabled">[],
  scope: IdexalPluginScope,
): IdexalCommand[] {
  const enabledPlugins = scopedPlugins.filter((plugin) => plugin.enabled);
