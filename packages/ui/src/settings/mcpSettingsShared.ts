import type { McpServerConfig, IdexalMcpServer } from "@idexal/shared";

export const MCP_SECTIONS = ["idexalagentmcp"] as const;
...
export function serverToForm(server: IdexalMcpServer): FormState {
...
// 与 shared 层 convertToIdexalAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
