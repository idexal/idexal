...
import type { IdexalPluginDiagnostic, IdexalPluginInfo } from "@idexal/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: IdexalPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<IdexalPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<IdexalPluginInfo["hookDetails"]>[number]): string {
