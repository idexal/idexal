...
import { TID_PLUGIN_STORE_BROWSE } from "@idexal/shared";
import type {
  IdexalPluginInfo,
  IdexalPluginScope,
...
function PluginList({
  ...
  const getPluginOptionValue = (
    ...
    key: string,
    option: IdexalPluginUserConfigOption,
  ...
  const savePluginOptions = async (plugin: IdexalPluginInfo) => {
  ...
  const renderPluginRows = (items: IdexalPluginInfo[]) => (
  ...
  return (
    <section className="space-y-6" aria-labelledby="plugin-installed-title">
      ...
      <RemoteSyncDialogs
        ...
        remoteIdexalAgentService={targetServiceResolution.services.idexalAgentService}
