...
export function buildAutomationModeOption(currentValue: string): IdexalConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 idexal-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: IdexalConfigOption | undefined,
  currentValue: string,
