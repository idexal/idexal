...
import type { CommandConfig, UserCommand, IdexalCommand } from "@idexal/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: IdexalCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: IdexalCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? IDEXAL_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
