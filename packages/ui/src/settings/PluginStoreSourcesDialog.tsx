...
import type { IdexalPluginMarketplaceSummary } from "@idexal/shared";
...
function isRemovableMarketplace(marketplace: IdexalPluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<IdexalPluginMarketplaceSummary["refreshFailure"]>;
}) {
