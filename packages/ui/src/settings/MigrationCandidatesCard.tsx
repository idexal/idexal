...
import type {
  ...
  IdexalImportedSessionSkippedItem,
} from "@idexal/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: IdexalImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: IdexalImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: IdexalImportSessionsResult | null;
  isImporting: boolean;
