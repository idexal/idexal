...
import type {
  IdexalSavedWorkflowArgType,
  IdexalSavedWorkflowArgsDeclaration,
} from "@idexal/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: IdexalSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: IdexalSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: IdexalSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: IdexalSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: IdexalSavedWorkflowArgsDeclaration = {};
