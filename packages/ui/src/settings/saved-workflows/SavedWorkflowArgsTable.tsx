...
import type { IdexalSavedWorkflowArgType } from "@idexal/shared";
...
const ARG_TYPES: readonly IdexalSavedWorkflowArgType[] = ["string", "number", "boolean", "json"];
          ...
          >
            <div className={cn("grid items-center gap-3", columns)}>
              ...
              <Select
                value={row.type}
                onValueChange={(value) =>
                  onChange(row.key, { type: value as IdexalSavedWorkflowArgType })
                }
              >
