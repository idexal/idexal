...
export function resolveCodingPlanEntitlementState({
  ...
  accountAvailability?: import("@idexal/provider").AccountProviderState["availability"];
  accountUnavailableReason?: import("@idexal/provider").AccountProviderState["unavailableReason"];
