...
export function CodingPlanStatusPanel({
  ...
  quotaResetAccountAccess?: IdexalProviderAccountAccess | IdexalAccountAccess;
...
function CodingPlanUsageSummaryCards({
  ...
  accountAccess?: IdexalProviderAccountAccess | IdexalAccountAccess;
        ...
        {cards.map((card) => (
          <PlanUsageMetricCard
            ...
            infoDescription={
              card.key === "serverMcp"
                ? intl.formatMessage({
                    id: "sidebar.usage.plan.idexalMcpDescription",
                  })
                : undefined
            }
          ...
          {infoDescription ? (
            <ControlHintTooltip title={infoDescription} standalone>
              <button
                ...
                data-idexal-mcp-info="model-settings"
              >
