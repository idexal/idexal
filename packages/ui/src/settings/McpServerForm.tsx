...
import type { McpSource, IdexalMcpServer } from "@idexal/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: IdexalMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: IdexalMcpServer) => void;
}) {
  const { intl } = useIdexalIntl();
