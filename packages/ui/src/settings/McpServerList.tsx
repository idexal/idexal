...
function McpServerItem({
  ...
  server: IdexalMcpServer;
  onEdit: (server: IdexalMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: IdexalMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "idexal";
