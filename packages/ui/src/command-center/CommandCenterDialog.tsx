...
import { unpackWorkspaceFileEntries } from "@idexal/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, IdexalTaskChangeSummary, IdexalTaskMeta } from "@idexal/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = IdexalTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = IdexalTaskChangeSummary["files"][number];
...
function getTaskTitle(task: IdexalTaskMeta, untitledLabel: string): string {
