import type { IdexalModelTrajectoryMessage } from "@idexal/services";
...
type IntlShape = ReturnType<typeof useIdexalIntl>["intl"];
...
function compactTextPreview(message: IdexalModelTrajectoryMessage): string {
...
function firstLinePreview(message: IdexalModelTrajectoryMessage): string {
...
function messageClipboardText(message: IdexalModelTrajectoryMessage): string {
