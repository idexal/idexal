...
import { TID_REMOTE_KIND_DOCKER, TID_REMOTE_KIND_SSH, TID_REMOTE_KIND_WSL } from "@idexal/shared";
import type {
  IMcpSyncService,
  IPluginSyncService,
  IServiceAccessor,
...
export function RemoteConnectionDirectoryStep({
  ...
  localIdexalAgentService?: IIdexalAgentService;
  remoteIdexalAgentService?: IIdexalAgentService | null;
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-6 h-full" aria-busy={selecting}>
      ...
      <RemoteSyncDialogs
        ...
        localIdexalAgentService={localIdexalAgentService}
        remoteIdexalAgentService={remoteIdexalAgentService}
