...
import { isCronTask, isOffPeakTask, type IdexalTaskMeta } from "@idexal/shared";
import { TID_TASK_ARCHIVE, TID_TASK_ITEM, testId } from "@idexal/shared";
...
function getTaskAutomationIdentity(task: IdexalTaskMeta): string | undefined {
  return task.cronAutomationId ?? (task as IdexalTaskMeta & { automationId?: string }).automationId;
}

function areTaskListItemTaskFieldsEqual(left: IdexalTaskMeta, right: IdexalTaskMeta) {
  if (left === right) {
    return true;
  }
