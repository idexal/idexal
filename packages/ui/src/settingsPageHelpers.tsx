...
export type { Locale, LocalePreference } from "@idexal/shared";
...
const IDEXAL_INTERACTION_BEHAVIOR_OPTIONS: readonly IdexalInteractionBehavior[] = [
  "queue",
  "guide",
];
...
export function GeneralSectionContent({
  ...
  onIdexalInteractionBehaviorChange: (behavior: IdexalInteractionBehavior) => Promise<void>;
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsGroupCard>
        <SettingsRow
          label={intl.formatMessage({ id: "settings.idexalInteractionBehavior" })}
          description={intl.formatMessage({
            id: "settings.idexalInteractionBehaviorDescription",
          })}
          control={
            <Select
              value={idexalInteractionBehavior}
              onValueChange={(value) => {
                void onIdexalInteractionBehaviorChange(value as IdexalInteractionBehavior);
              }}
            >
              <SelectTrigger size="lg" className="w-[260px] min-w-0 justify-between">
                <SelectValue />
              ...
              <SelectContent>
                {IDEXAL_INTERACTION_BEHAVIOR_OPTIONS.map((behavior) => (
                  <SelectItem key={behavior} value={behavior}>
                    {intl.formatMessage({
                      id: `settings.idexalInteractionBehavior.option.${behavior}`,
                    })}
                  </SelectItem>
                ))}
              </SelectContent>
