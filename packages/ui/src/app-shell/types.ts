...
import type { IFeedbackService, IServiceAccessor } from "@idexal/services";
...
import type { WorkspaceIdexalUIState } from "@/store/idexalSessionStore.js";
...
export interface WorkspaceShellIdexalState {
  activeTaskId: WorkspaceIdexalUIState["activeTaskId"];
  draftFocusVersion: WorkspaceIdexalUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceIdexalUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceIdexalUIState["modelSwitchStage"];
  selectedProvider: WorkspaceIdexalUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceIdexalUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceIdexalUIState["workspaceInit"];
  taskStatus: IdexalTaskRuntimeStatus;
...
export type CreateTaskRequest = IdexalProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@idexal/shared").RemoteTarget;
    workspaceIdentity?: string;
  ...
  activeTaskProvider: IdexalProvider | null;
  resolvedActiveTaskMeta?: IdexalTaskMeta | null;
  ...
  handleStartDraftInWorkspace: (
    targetWorkspacePath: string,
    targetWorkspaceIdentity?: string,
    targetWorkspacePurpose?: import("@idexal/shared").WorkspacePurpose,
    createSource?: SessionCreateSource,
  ) => void;
