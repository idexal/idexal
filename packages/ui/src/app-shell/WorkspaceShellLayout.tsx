...
import { TID_APP_HEADER } from "@idexal/shared";
...
import type { ComposerMentionPrefill } from "@/store/idexalSessionStoreTypes.js";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "idexal:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellIdexalState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`Idexal / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellIdexalState}
                          gitSummary={gitState.summary}
