...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useIdexalStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useIdexalStore(
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.idexal/AGENTS.md",
          },
        ),
