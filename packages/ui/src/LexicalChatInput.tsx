...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __idexalLexicalInputE2E?: typeof bridge }).__idexalLexicalInputE2E === bridge
      ) {
        delete (input as { __idexalLexicalInputE2E?: typeof bridge }).__idexalLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__idexalLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
