...
import type { IdexalGroupedTaskViewNode, IdexalTaskGroupColor } from "@idexal/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: IdexalTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: IdexalTaskMeta) => string;
  onSelectTask: (workspacePath: string, taskId: string, workspaceIdentity?: string) => void;
  onCloseTask: (task: IdexalTaskMeta) => void;
  onOpenFileTree?: (task: IdexalTaskMeta) => void;
  onCreateTask: () => void;
  ...
  onUpdateGroupColor: (groupId: string, color: IdexalTaskGroupColor) => void;
  onUngroupGroup: (groupId: string) => void;
  onMoveTaskToGroup: (task: IdexalTaskMeta, groupId: string | null) => void;
  onMoveTaskToTop: (task: IdexalTaskMeta) => void;
  onStartRenameTask: (task: IdexalTaskMeta) => void;
  onArchiveTask: (task: IdexalTaskMeta) => void;
  onMarkTaskAsUnread: (task: IdexalTaskMeta) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as IdexalTaskGroupColor);
    },
