import type { IdexalTaskGroupColor } from "@idexal/services";
...
const TASK_GROUP_COLOR_CLASS: Record<IdexalTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<IdexalTaskGroupColor, string> = {
