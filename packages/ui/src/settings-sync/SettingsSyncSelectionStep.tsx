...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@idexal/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useIdexalIntl>["intl"]): string {
  switch (agent) {
    case "idexal":
      return intl.formatMessage({ id: "settingsSync.agent.idexal" });
    case "claudeCode":
