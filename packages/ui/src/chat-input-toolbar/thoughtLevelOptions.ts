import type { IdexalConfigOption, IdexalProvider } from "@idexal/shared";
import type { useIdexalIntl } from "@/i18n/IntlProvider.js";
import { getConfigOptionEntryLabel } from "@/chat-input-toolbar/display.js";

type ThoughtLevelEntry = NonNullable<IdexalConfigOption["options"]>[number];
...
export function getNextThoughtLevelValue(
  option: Pick<IdexalConfigOption, "type" | "currentValue" | "options">,
): string | null {
