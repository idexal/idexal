...
type ContextUsageBreakdownSource = IdexalContextUsageBreakdownItem["source"];
...
function buildContextUsageBreakdownSegments(
  breakdown: readonly IdexalContextUsageBreakdownItem[] | undefined,
...
export function getRenderableTaskUsage<T extends { used: number; size: number }>(
  ...
  // Idexal Protocol 迁移后会单独补齐真实 contextUsed/contextWindow。
...
export function getContextCompressionCommand(_provider: IdexalProvider): string {
  return "/compact";
}
