 ...
 *
 * 一行的读法与模型面
 * （apps/idexal-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@idexal/shared/idexal-protocol-v4";
...
type FormatMessage = ReturnType<typeof useIdexalIntl>["intl"]["formatMessage"];
