...
import type { ApplicationIconRequest } from "@idexal/shared";
import { useIdexalIntl } from "@/i18n/IntlProvider.js";
import { isIdexalCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_idexal_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isIdexalCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useIdexalIntl>["intl"];
