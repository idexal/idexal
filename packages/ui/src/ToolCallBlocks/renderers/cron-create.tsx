...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@idexal/shared";
import type { IdexalAutomationScheduleRule } from "@idexal/shared";
...
function isScheduleRule(value: unknown): value is IdexalAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as IdexalAutomationScheduleRule)
    : undefined;
