...
import type { CommandAck, WorkflowRunState } from "@idexal/shared/idexal-protocol-v4";
...
import { encodeCustomModelValue } from "@/lib/idexalCustomModelValue.js";
...
function WorkflowRunSettingsForm({
  ...
  const groups = useMemo(
    () =>
      view === null
        ? []
        : buildRegistryModelSelectGroups(IDEXAL_AGENT_PROVIDER, view, {
