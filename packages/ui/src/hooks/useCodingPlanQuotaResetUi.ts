...
import type { IUsageStatsService } from "@idexal/services";
import type {
  CodingPlanResetScopeRequest,
  CodingPlanResetStatusSnapshot,
  CodingPlanResetType,
  IdexalAccountAccess,
  IdexalProviderAccountAccess,
} from "@idexal/shared";
...
export function useCodingPlanQuotaResetUi({
  ...
  accountAccess?: IdexalProviderAccountAccess | IdexalAccountAccess | null;
  enabled?: boolean;
