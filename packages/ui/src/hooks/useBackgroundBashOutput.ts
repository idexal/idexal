...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@idexal/shared";
import { useIdexalAgentService } from "@/hooks/useIdexalAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useIdexalAgentService(workspacePath, remoteSessionId, workspaceIdentity);
