/**
 * Idexal Agent ConfigOptions 便捷 hooks
 *
...
import type { ConfigOptionsStatus } from "@/store/idexalSessionStoreTypes.js";
...
export function useToolbarConfigOptions(
  ...
  const { configOptions, configOptionsStatus } = useIdexalSessionStore(
    useShallow((state) => {
