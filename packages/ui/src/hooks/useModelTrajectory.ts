 ...
 *
 * 路径解析与文件读取都收口在 idexalTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [idexalTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
