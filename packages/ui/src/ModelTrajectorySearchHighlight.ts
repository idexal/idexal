...
const HIGHLIGHT_NAME = "idexal-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "idexal-model-trajectory-find-active";
const STYLE_ID = "idexal-model-trajectory-find-highlight-style";
