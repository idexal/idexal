...
import type { IdexalModelTrajectoryRecord } from "@idexal/services";
import {
...
export function resolveTrajectoryTimelineItems(records: IdexalModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: IdexalModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: IdexalModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: IdexalModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): IdexalModelTrajectoryRecord["request"]["messages"] {
