import type { IPlatformService, Locale, UpdateStatePayload } from "@idexal/shared";
import { useCallback, useEffect, useRef, useState } from "react";
import { IdexalIntlProvider } from "@/i18n/IntlProvider.js";
...
export function UpdateStatusWindowRoot({
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground">
      ...
      <IdexalIntlProvider key={locale} initialLocale={locale}>
