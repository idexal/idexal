...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 idexalAgentService 拉取插件 overview */
  getPluginsOverview: IIdexalAgentService["getPluginsOverview"];
  /** E2E 通过真实 idexalAgentService 添加 marketplace */
  addPluginMarketplace: IIdexalAgentService["addPluginMarketplace"];
  /** E2E 通过真实 idexalAgentService 刷新 marketplace */
  updatePluginMarketplace: IIdexalAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 idexalAgentService 安装 marketplace plugin */
  installPlugin: IIdexalAgentService["installPlugin"];
  /** E2E 通过真实 idexalAgentService 触发插件 discover */
  listPlugins: IIdexalAgentService["listPlugins"];
  /** E2E 通过真实 idexalAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IIdexalAgentService["getPluginReferenceCatalog"];
}
