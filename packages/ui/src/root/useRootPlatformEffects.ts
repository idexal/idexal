...
export function useRootPlatformEffects({
  ...
  initialWorkspacePurpose?: import("@idexal/shared").WorkspacePurpose;
  ...
  isDesktop?: boolean;
  locale: ReturnType<typeof import("@/i18n/IntlProvider.js").useIdexalIntl>["locale"];
  tabs: WindowTabState[];
  ...
  intl: ReturnType<typeof import("@/i18n/IntlProvider.js").useIdexalIntl>["intl"];
  ...
  useEffect(() => {
    ...
    const disposeNotificationClick = platform.onTaskNotificationClick((taskId: string) => {
      ...
      const workspaces = useIdexalSessionStore.getState().workspaces;
  ...
  useEffect(() => {
    ...
    void baseServices.conversationShareService
      ...
      .then((result) => {
        ...
        const sessionStore = useIdexalSessionStore.getState();
  ...
  useEffect(() => {
    ...
    syncActiveSession();
    return useIdexalSessionStore.subscribe(syncActiveSession);
