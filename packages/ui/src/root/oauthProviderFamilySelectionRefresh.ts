...
import type { AccountProviderState } from "@idexal/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, IdexalProviderAccountAccess | IdexalAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: IdexalProviderAccountAccess | IdexalAccountAccess =
