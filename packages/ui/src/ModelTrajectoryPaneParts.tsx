...
export type IntlShape = ReturnType<typeof useIdexalIntl>["intl"];
...
export function CallCard({
  ...
  record: IdexalModelTrajectoryRecord;
  index: number;
  inputMessages: IdexalModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: IdexalModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<IdexalModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<IdexalModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: IdexalModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<IdexalModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
