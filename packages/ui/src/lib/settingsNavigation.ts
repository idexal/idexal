...
const SETTINGS_SECTION_INTENT_KEY = "idexal-settings-section-intent",
  SETTINGS_USAGE_TAB_INTENT_KEY = "idexal-settings-usage-tab-intent",
  SETTINGS_PLUGIN_TAB_INTENT_KEY = "idexal-settings-plugin-tab-intent",
  SETTINGS_PLUGIN_ORIGIN_INTENT_KEY = "idexal-settings-plugin-origin-intent",
  SETTINGS_PLUGIN_SCOPE_KEY_INTENT_KEY = "idexal-settings-plugin-scope-key-intent";
const SETTINGS_MODEL_PROVIDER_ID_INTENT_KEY = "idexal-settings-model-provider-id-intent";
const SETTINGS_SECTION_INTENT_EVENT = "idexal:settings-section-intent",
  SETTINGS_LAST_SECTION_STORAGE_KEY = "idexal-settings-last-section";
const HIDDEN_SETTINGS_SECTIONS = new Set<SettingsSectionId>([
  ...
  "plugins",
  // 工作区搜索（.idexalignore）设置入口先隐藏：规则文件仍生效并可手动编辑，
  // 编辑页代码保留，放开时从这里移除即可。
  "workspaceFileSearch",
  "computerUse",
]);
