  ...
  if (options.streaming) {
    ...
    if (unclosedStart !== null) {
      ...
      const prefixStart = findAssistantDirectivePrefixStart(
        content,
        [CODE_COMMENT_DIRECTIVE_NAME, "idexal-file-citation"],
        protectedRanges,
        {
          minimumSingleColonPrefixLength: ":idexal".length,
          singleColonDirectiveNames: ["idexal-file-citation"],
          tripleColonDirectiveNames: ["idexal-file-citation"],
        },
      );
      if (prefixStart !== null) {
