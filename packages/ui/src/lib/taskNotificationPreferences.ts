const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "idexal-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "idexal-notification-sound-enabled";
