...
interface ResolveWorkspaceSwitchDraftProviderOptions {
  currentSelectedProvider: IdexalProvider;
  targetWorkspacePath: string;
  targetWorkspaceIdentity?: string;
  workspaces: Record<string, WorkspaceIdexalUIState | undefined>;
}
...
export function resolveWorkspaceSwitchDraftProvider({
  ...
  workspaces,
}: ResolveWorkspaceSwitchDraftProviderOptions): IdexalProvider {
