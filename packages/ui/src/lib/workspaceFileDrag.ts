...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-idexal-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "idexal:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "idexal:workspace-file-drag-state";
