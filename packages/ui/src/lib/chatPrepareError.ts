...
export type ModelConfigMissingUiError = IdexalError & {
...
export function isProviderNotReadyError(error: unknown): boolean {
  return normalizeUnknownError(error).code === IDEXAL_AGENT_PROVIDER_NOT_READY_CODE;
}
