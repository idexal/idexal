...
import type { IdexalTaskMeta, IdexalWorkspaceTaskListChanged } from "@idexal/shared";
...
import { getTaskUnreadIndicator, useIdexalSessionStore } from "@/store/idexalSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IIdexalTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: IdexalWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: IdexalWorkspaceTaskListChanged;
}): boolean {
