import type { IdexalUsage } from "@idexal/shared";
import type { TaskUsageState } from "@/store/idexalSessionStoreTypes.js";
...
export function buildPromptCompletionUsageFallback(
  ...
  // 只有从未收到过正数 usage_update 的 provider 才把它当弱 fallback，避免覆盖 idexal-cli/GLM 的真实 context used。
  return {
    ...currentUsage,
    size: contextWindow,
