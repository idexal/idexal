...
function hasOwnTaskMetaField<T extends keyof IdexalTaskMeta>(task: IdexalTaskMeta, key: T) {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<IdexalTaskMeta | null | undefined>
): IdexalTaskMeta | undefined {
  let merged: IdexalTaskMeta | undefined;
