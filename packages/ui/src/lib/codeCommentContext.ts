export const CODE_COMMENT_ADD_TO_CHAT_EVENT = "idexal:code-comment-add-to-chat";
export const CODE_COMMENT_REMOVE_FROM_CHAT_EVENT = "idexal:code-comment-remove-from-chat";
