...
import { resolveWorkspaceStateKey } from "@/store/idexalSessionStoreSelectors.js";

export type TaskEntityKey = string;
export type TaskListCacheKey = string;
export type TaskListQueryKind = IdexalTaskListKind | "workspace";
...
function normalizeTaskListWorkspaceScopes(
  ...
  const uniqueScopes = new Map<string, IdexalTaskListWorkspaceScope>();
