...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@idexal/shared";
...
const PLAYWRIGHT_WORLD_NAME = "idexal-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__idexalPlaywrightInjected";
