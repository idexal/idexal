...
import type { ApplicationIconInfo } from "@idexal/shared";
...
public static class IdexalAumidIcon {
...
'@;
$idexalIconBytes=[IdexalAumidIcon]::Read($idexalArg0);
[Console]::Out.Write([Convert]::ToBase64String($idexalIconBytes));
`;
