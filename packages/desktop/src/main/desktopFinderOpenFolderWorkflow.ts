...
const WORKFLOW_NAME = "Open in Idexal.workflow";
const WORKFLOW_BUNDLE_ID = "dev.idexal.app.finder-open-workflow";
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "idexal://workspace/open?path=\${encoded}"
fi
`;
