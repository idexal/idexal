...
import { HELPER_APP_NAME } from "@idexal/idexal-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@idexal/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.IDEXAL_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
