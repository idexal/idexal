...
function mapMcpTelemetryEvent(event: Exclude<IdexalMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<IdexalMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
