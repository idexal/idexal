...
const UPDATE_FEED_URL_ENV = "IDEXAL_UPDATE_FEED_URL";
const UPDATE_FEED_URL_SWITCH = "--idexal-update-feed-url";
const DEV_AUTO_UPDATE_ENV = "IDEXAL_AUTO_UPDATE_DEV";
const DEV_AUTO_UPDATE_SWITCH = "--idexal-auto-update-dev";
const DEV_AUTO_UPDATE_VERSION_ENV = "IDEXAL_AUTO_UPDATE_DEV_VERSION";
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--idexal-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  idexalReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.idexalReleaseChannel === "preview" || info.idexalReleaseChannel === "stable"
    ? info.idexalReleaseChannel
    : null;
}
...
function applyManifestUpdateProvider(options: InitAutoUpdaterOptions): void {
  ...
  autoUpdater.setFeedURL({
    ...
    resolveEndpointOrigin:
      options.resolveEndpointOrigin ?? (() => resolveRuntimeIdexalEndpointOrigin(process.env)),
