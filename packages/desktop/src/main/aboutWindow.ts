import { ABOUT_WINDOW_LOGO_DATA_URI } from "./aboutWindowLogo.js";
      ...
      <section class="about-card" role="dialog" aria-modal="true" aria-labelledby="about-title">
        <div class="content">
          <div class="app-icon" aria-hidden="true">
            <!--
              修复：这里原先内联的是上游旧品牌的 Chevron SVG，品牌重构后必须换成官方标志。
              .app-icon 是固定深色底（#000→#151718），所以使用深色背景专用的白色标志；
              About 窗口以 data:text/html 加载且 CSP 只放行 img-src data:，故走内联 data URI。
            -->
            <img class="app-logo" src="${ABOUT_WINDOW_LOGO_DATA_URI}" alt="" draggable="false" />
          </div>
