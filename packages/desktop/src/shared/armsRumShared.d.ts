import { type IdexalRuntimeEnv } from "@idexal/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: IdexalRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@idexal/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
