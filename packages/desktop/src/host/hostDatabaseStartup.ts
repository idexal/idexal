import {
  ...
  resolveIdexalAgentSpawnCwd,
} from "@idexal/services/storage-startup";
import type { DatabaseStartupState } from "@idexal/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveIdexalAgentSpawnCwd({
