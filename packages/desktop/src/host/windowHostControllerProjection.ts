...
import type { IdexalArchivedTaskDeletionResult } from "@idexal/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: IdexalTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | IdexalArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: IdexalTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
