import { Event as RpcEvent } from "@idexal/rpc";
import type { IConversationShareService, IIdexalAgentService } from "@idexal/services";
import { conversationShareConnectionScopeFactory } from "@idexal/services/node";
