...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "idexal";
export const DEV_ELECTRON_APP_NAME = "Idexal Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.idexal.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 idexal URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 idexal 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".idexal-dev-electron-source.json");
