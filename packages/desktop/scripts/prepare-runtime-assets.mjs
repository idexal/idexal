...
const shouldSkipRemoteAssets = process.env.IDEXAL_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (IDEXAL_SKIP_REMOTE_ASSETS=1)");
}
