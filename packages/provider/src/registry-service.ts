...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnIdexalBuiltinRevision !== config.idexalBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          idexalBuiltinProviders: config.idexalBuiltinProviders,
          idexalBuiltinProviderTemplates: config.idexalBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          idexalBuiltinModelRules: config.idexalBuiltinModelRules,
