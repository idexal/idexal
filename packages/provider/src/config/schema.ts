import { z } from "zod";
import { modelConfigDataSchema } from "@idexal/shared/model-config";
...
export function parseIdexalBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseIdexalBuiltinProviderConfigRules(input: unknown): {
...
export function parseIdexalBuiltinModelConfigRules(input: unknown): ModelConfigRules {
