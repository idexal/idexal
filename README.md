...
>
> Website: https://idexal.com — خارطة الطريق: [ROADMAP.md](ROADMAP.md)

This project is a distribution of the open-source [`Code - OSS`](https://github.com/microsoft/vscode) repository, rebranded and extended as the **Idexal** agentic IDE. The upstream source code remains available under the standard [MIT license](https://github.com/microsoft/vscode/blob/main/LICENSE.txt).
