...
import {
  Store, Search, Download, Trash2, Check, Star, ExternalLink,
  Filter, Grid, List, ArrowUpDown, Loader2, Shield, Zap, Palette,
  Code, Terminal, GitBranch, Brain, Box, Eye
} from 'lucide-react'
...
const MOCK_EXTENSIONS: MarketplaceExtension[] = [
  { id: 'ms-vscode.prettier', name: 'prettier', displayName: 'Prettier - Code formatter', description: 'Code formatter using prettier', author: 'Prettier', version: '10.4.0', downloads: 28000000, rating: 4.8, ratingCount: 4500, icon: '🎨', category: 'Formatters', tags: ['prettier', 'format'], installed: true, enabled: true, featured: true, verified: true, lastUpdated: '2024-02-15' },
  ...
  { id: 'bradlc.vscode-tailwindcss', name: 'tailwindcss', displayName: 'Tailwind CSS IntelliSense', description: 'Tailwind CSS tooling for VS Code', author: 'Tailwind Labs', version: '0.10.4', downloads: 12000000, rating: 4.9, ratingCount: 2100, icon: '🌊', category: 'Linters', tags: ['tailwind', 'css'], installed: false, enabled: false, featured: true, verified: true, lastUpdated: '2024-02-12' },
  ...
  { id: 'eamodio.gitlens', name: 'gitlens', displayName: 'GitLens — Git supercharged', description: 'Supercharge Git within VS Code', author: 'GitKraken', version: '14.2.0', downloads: 15000000, rating: 4.8, ratingCount: 5200, icon: '🔍', category: 'SCM Providers', tags: ['git', 'lens'], installed: true, enabled: true, featured: true, verified: true, lastUpdated: '2024-02-14' },
  ...
  { id: 'formulahendry.code-runner', name: 'coderunner', displayName: 'Code Runner', description: 'Run code snippets in multiple languages', author: 'Jun Han', version: '0.12.1', downloads: 18000000, rating: 4.6, ratingCount: 3200, icon: '▶️', category: 'Other', tags: ['run', 'code'], installed: false, enabled: false, featured: false, verified: false, lastUpdated: '2023-11-15' },
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {selectedExt.verified && <Shield size={12} className="text-blue-400" />}
                </div>
                ...
                <div className="flex gap-2 mt-3">
                  {selectedExt.installed ? (
                    ...
                    >
                      {installingId === selectedExt.id ? <Loader2 size={10} className="animate-spin" /> : <Download size={10} />}
                      Install
                    </button>
                  )}
                </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    {ext.verified && <Shield size={10} className="text-blue-400 flex-shrink-0" />}
                    {ext.featured && <Star size={10} className="text-yellow-400 flex-shrink-0 fill-yellow-400" />}
                  </div>
                ...
                >
                  {installingId === ext.id ? <Loader2 size={10} className="animate-spin" /> : ext.installed ? <Check size={10} /> : <Download size={10} />}
