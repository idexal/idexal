...
import {
  ListTree, X, ChevronDown, ChevronRight, Search,
  Braces, FunctionSquare, Type, Box, Package,
  Circle, Diamond, Hash, Tag, FileText, Layers
} from 'lucide-react'
...
const KIND_ICONS: Record<SymbolKind, React.ReactNode> = {
  ...
  module: <Package className="w-3.5 h-3.5" />,
  namespace: <Layers className="w-3.5 h-3.5" />,
  package: <Package className="w-3.5 h-3.5" />,
  class: <Box className="w-3.5 h-3.5 text-ide-warning" />,
  method: <Braces className="w-3.5 h-3.5 text-ide-accent" />,
  property: <Tag className="w-3.5 h-3.5 text-ide-text-muted" />,
  field: <Tag className="w-3.5 h-3.5 text-ide-text-muted" />,
  constructor: <Diamond className="w-3.5 h-3.5 text-ide-warning" />,
  enum: <Circle className="w-3.5 h-3.5 text-ide-success" />,
  interface: <Type className="w-3.5 h-3.5 text-purple-400" />,
  function: <FunctionSquare className="w-3.5 h-3.5 text-blue-400" />,
  variable: <Hash className="w-3.5 h-3.5 text-ide-text-muted" />,
  constant: <Hash className="w-3.5 h-3.5 text-green-400" />,
  string: <Hash className="w-3.5 h-3.5" />,
  number: <Hash className="w-3.5 h-3.5" />,
  boolean: <Hash className="w-3.5 h-3.5" />,
  array: <Hash className="w-3.5 h-3.5" />,
  object: <Hash className="w-3.5 h-3.5" />,
  typeParameter: <Type className="w-3.5 h-3.5 text-purple-400" />,
  type: <Type className="w-3.5 h-3.5 text-purple-400" />,
  parameter: <Hash className="w-3.5 h-3.5 text-ide-text-muted" />,
  enumMember: <Circle className="w-3.5 h-3.5 text-ide-success" />,
  import: <Package className="w-3.5 h-3.5 text-ide-text-muted" />,
}
    ...
    <div className="h-full flex flex-col bg-ide-surface">
      ...
      <div className="h-10 px-4 flex items-center justify-between border-b border-ide-border">
        <div className="flex items-center gap-2">
          <ListTree className="w-4 h-4 text-ide-accent" />
