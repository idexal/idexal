...
import {
  Rocket, Key, Cpu, Terminal, GitBranch, Keyboard,
  ...
  return (
    <div className="text-center">
      <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-ide-accent/10 flex items-center justify-center">
        <Rocket className="w-8 h-8 text-ide-accent" />
      </div>
  ...
  return (
    <div>
      <div className="text-center mb-6">
        <Cpu className="w-10 h-10 text-ide-accent mx-auto mb-3" />
      ...
      <div className="space-y-3">
        {providers.map((p) => (
          ...
          >
            ...
            {settings.activeProvider === p.id && (
              <Check className="w-5 h-5 text-ide-accent ml-auto" />
            )}
          </button>
        ))}
      </div>
...
function ApiKeyStep({ settings }: { settings: any }) {
  return (
    <div>
      <div className="text-center mb-6">
        <Key className="w-10 h-10 text-ide-accent mx-auto mb-3" />
...
function FeaturesStep() {
  const features = [
    ...
    { icon: '📝', title: 'Code Generation', desc: 'Apply code changes directly from chat' },
    { icon: '🔍', title: 'Code Review', desc: 'Get instant feedback on your code' },
  ...
  return (
    <div>
      <div className="text-center mb-6">
        <Sparkles className="w-10 h-10 text-ide-accent mx-auto mb-3" />
...
function ShortcutsStep() {
  ...
  return (
    <div>
      <div className="text-center mb-6">
        <Keyboard className="w-10 h-10 text-ide-accent mx-auto mb-3" />
  ...
  return (
    <div className="text-center">
      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-ide-success/10 flex items-center justify-center">
        <Check className="w-8 h-8 text-ide-success" />
      </div>
