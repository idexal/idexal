...
import {
  Package, Search, Copy, Check, Eye, Code, Palette, Star,
  ChevronDown, ChevronRight, ExternalLink, Box, Grid
} from 'lucide-react'
            ...
            {filtered.map(comp => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-1 text-xs text-ide-text-secondary">
                  <span className="flex items-center gap-0.5"><Star size={8} className="text-yellow-400" /> {comp.usageCount}</span>
