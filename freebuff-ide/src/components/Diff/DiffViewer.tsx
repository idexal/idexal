...
import {
  FileText, Copy, Check, ChevronDown, ChevronRight, ArrowLeft,
  ArrowRight, Search, Filter, Plus, Minus, RotateCcw
} from 'lucide-react'
        ...
        {MOCK_FILES.map((f, i) => {
          ...
          return (
            ...
            >
              ...
              <FileText size={12} className="text-ide-text-secondary flex-shrink-0" />
              ...
              {filteredDiff.filter(l => l.type !== 'added').map((line, i) => (
                ...
                >
                  ...
                  <div className="w-5 flex items-center justify-center flex-shrink-0">
                    {line.type === 'removed' && <Minus size={10} className="text-red-400" />}
                  </div>
            ...
            <div className="flex-1">
              {filteredDiff.filter(l => l.type !== 'removed').map((line, i) => (
                ...
                >
                  ...
                  <div className="w-5 flex items-center justify-center flex-shrink-0">
                    {line.type === 'added' && <Plus size={10} className="text-green-400" />}
                  </div>
                  <div className={`flex-1 px-2 py-0.5 whitespace-pre ${
