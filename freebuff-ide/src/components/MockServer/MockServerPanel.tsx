...
import {
  Server, Plus, Trash2, Play, Square, Copy, Check, Edit3,
  ChevronDown, ChevronRight, Clock, Hash, Route, ArrowRight
} from 'lucide-react'
      ...
      <div className="flex-1 overflow-y-auto">
        {endpoints.map(ep => (
          <div key={ep.id} className="border-b border-ide-border/30">
            ...
            >
              {expandedId === ep.id ? <ChevronDown size={12} /> : <ChevronRight size={12} />}
