...
import {
  Bell, BellOff, AlertCircle, AlertTriangle, Info, CheckCircle,
  Trash2, Filter, Clock, X, Volume2, VolumeX, Settings,
...
const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  { id: '2', type: 'error', title: 'TypeScript Error', message: "Property 'name' does not exist on type 'Props'", source: 'Code Intelligence', timestamp: new Date(Date.now() - 300000), read: false },
  ...
  { id: '10', type: 'info', title: 'Code Review Complete', message: '3 suggestions found in PR #42', source: 'AI Review', timestamp: new Date(Date.now() - 10800000), read: true },
]
