...
import { GitBranch, AlertCircle, CheckCircle, Wifi, Cpu, Zap, Settings } from 'lucide-react'
...
export default function StatusBar({ onOpenTerminal, onOpenChat, onOpenGit }: StatusBarProps) {
  return (
