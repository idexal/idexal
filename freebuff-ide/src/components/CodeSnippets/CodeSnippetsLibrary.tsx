...
import {
  Code, Search, Star, StarOff, Copy, Check, Tag, Filter,
  ChevronDown, ChevronRight, Folder, FileText, Plus, Trash2,
  Download, Upload, Clock, Zap
} from 'lucide-react'
              ...
              >
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <button onClick={e => { e.stopPropagation(); toggleFavorite(snippet.id) }} className="flex-shrink-0">
                    {snippet.isFavorite ? (
                      ...
                      <StarOff size={12} className="text-ide-text-secondary/30" />
                    )}
                  </button>
                ...
                <div className="text-[10px] text-ide-text-secondary ml-7 flex items-center gap-2">
                  ...
                  <span className="flex items-center gap-0.5">
                    <Tag size={8} /> {snippet.tags.slice(0, 2).join(', ')}
                  </span>
                </div>
              </div>
              ...
              {isExpanded && (
                <div className="border-b border-ide-border/30 bg-ide-bg-secondary/10">
                  ...
                  <div className="px-3 py-1 flex items-center gap-2 text-[10px] text-ide-text-secondary border-t border-ide-border/20">
                    ...
                    <span>•</span>
                    <span className="flex items-center gap-0.5"><Clock size={8} /> {snippet.usageCount} uses</span>
                  </div>
                </div>
              )}
            </div>
