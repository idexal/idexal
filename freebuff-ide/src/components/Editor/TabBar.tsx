...
import { X, SplitSquareVertical, Plus, MoreHorizontal, Copy, ArrowLeftRight } from 'lucide-react'
      ...
      <div className="h-10 bg-ide-surface border-b border-ide-border flex items-center">
        ...
        <div className="flex items-center gap-0.5 px-2 flex-shrink-0">
          ...
          {onToggleDirection && (
            ...
            >
              <ArrowLeftRight className={`w-4 h-4 ${splitDirection === 'vertical' ? 'rotate-90' : ''}`} />
            </button>
          )}
          <button
            className="p-1.5 rounded hover:bg-ide-border text-ide-text-muted hover:text-ide-text transition-colors"
