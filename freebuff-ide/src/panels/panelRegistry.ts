...
const ExtensionMarketplacePanel = lazy(() => import('../components/ExtensionMarketplace/ExtensionMarketplacePanel'))
...
export const panelRegistry: Record<string, PanelConfig> = {
  ...
  'query-history':    { component: QueryHistoryPanel,    shortcut: { key: ';' } },
  ...
  'api-docs':         { component: APIDocGeneratorPanel },
