...
const LEAD_AGENTS: Record<LeadAgentType, Omit<LeadAgent, 'currentTasks' | 'totalCompleted' | 'avgResponseTime' | 'successRate'>> = {
  engineering: {
    ...
    icon: '🏗️',
    color: 'text-blue-400',
    description: 'Manages code implementation, architecture, and technical design. Delegates to Code, Architect, and Debug agents.',
    subAgents: ['code', 'architect', 'debug'],
    maxConcurrent: 5,
    specialties: ['implementation', 'architecture', 'debugging', 'refactoring', 'technical-design'],
  ...
  operations: {
    ...
    description: 'Manages deployment, infrastructure, and DevOps. Delegates to DevOps, Security, and Performance agents.',
    subAgents: ['devops', 'security', 'performance'],
    maxConcurrent: 3,
    specialties: ['deployment', 'ci-cd', 'infrastructure', 'monitoring', 'scaling'],
    canHandleDirectly: true,
  },
}
